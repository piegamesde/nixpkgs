...
assert builtins.unsafeGetAttrPos "a" (discardPositions { a = true; }) == null; {
  imports = [
    {
      ...
      options.generated = discardPositions {
        line18 = lib.mkOption { type = lib.types.int; };
      };
  ...
  options.submoduleLine34 = lib.mkOption {
    ...
    type = lib.types.submoduleWith {
      modules = [
        ({ options, ... }: { options.submodDeclLine39 = lib.mkOption { }; })
  ...
  config = {
    submoduleLine34.submodDeclLine39 =
      (options.submoduleLine34.type.getSubOptions [ ])
      .submodDeclLine39.declarationPositions;
  };
}
