  ...
  let
    keystore = {
      ...
      crypto = {
        cipher = "aes-128-ctr";
        ciphertext =
          "ad8341d8ef225650403fd366c955f41095e438dd966a3c84b3d406818c1e366c";
        ...
        kdfparams = {
          ...
          r = 8;
          salt =
            "d1a153845bb80cd6274c87c5bac8ac09fdfac5ff131a6f41b5ed319667f12027";
        };
        mac =
          "a9621ad88fa1d042acca6fc2fcd711f7e05bfbadea3f30f379235570c8e270d3";
      };
