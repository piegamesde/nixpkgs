        ...
        { config, ... }:
        {
          ...
          systemd.services.rtmp-publish = {
            ...
            serviceConfig = {
              ...
              ExecStart = "${
                ...
                }/bin/ffmpeg -re -f lavfi -i smptebars=size=800x600:rate=10 -c libx264 -f flv rtmp://localhost:1935/test";
            };
          };
          ...
          systemd.services.rtmp-receive = {
            ...
            serviceConfig = {
              ...
              ExecStart = "${
                  lib.getBin pkgs.ffmpeg-headless
                }/bin/ffmpeg -y -re -i rtmp://localhost:1935/test -f flv /dev/null";
            };
          };
        };
    };
