        ...
        services.frigate = {
          ...
          settings = {
            ...
            cameras.test = {
              ffmpeg = {
                input_args =
                  "-fflags nobuffer -strict experimental -fflags +genpts+discardcorrupt -r 10 -use_wallclock_as_timestamps 1";
                inputs = [{
        ...
        systemd.services.video-stream = {
          ...
          serviceConfig = {
            ...
            ExecStart = "${
              ...
              }/bin/ffmpeg -re -f lavfi -i smptebars=size=800x600:rate=10 -f mpegts -listen 1 http://0.0.0.0:8080";
          };
        };
      };
    };
