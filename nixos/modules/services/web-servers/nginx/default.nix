        ...
        ${
          optionalString cfg.statusPage ''
            server {
              ...
              ${
                optionalString enableIPv6 "listen [::]:${
                  toString cfg.defaultHTTPListenPort
                };"
              }
          ...
          types.submodule (
            {
              ...
              options = {
                enable =
                  mkEnableOption (lib.mdDoc "this proxy cache path entry");
    ...
    security.acme.certs =
      let
        acmePairs = map
          ...
          (
            filter
            (vhostConfig: vhostConfig.useACMEHost == null)
            acmeEnabledVhosts
          );
      in
