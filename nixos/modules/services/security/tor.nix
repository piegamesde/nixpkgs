  ...
  options = {
    services.tor = {
      ...
      openFirewall = mkEnableOption
        (lib.mdDoc "opening of the relay port(s) in the firewall");
      ...
      enableGeoIP = mkEnableOption (lib.mdDoc ''
      ...
      controlSocket.enable = mkEnableOption (lib.mdDoc ''
        control socket,
      ...
      settings = mkOption {
        ...
        type = types.submodule {
          ...
          options.MaxAdvertisedBandwidth =
            optionBandwidth "MaxAdvertisedBandwidth";
          ...
          options.PublishServerDescriptor = mkOption {
            description =
              lib.mdDoc (descriptionGeneric "PublishServerDescriptor");
            type = with types;
              nullOr (enum [
                false
                true
  ...
  config = mkIf cfg.enable {
    ...
    services.tor.settings = mkMerge [
      ...
      (mkIf cfg.relay.enable (
        ...
        } // optionalAttrs (elem cfg.relay.role [
          "bridge"
          "private-bridge"
        ]) {
          BridgeRelay = true;
      ...
      (mkIf cfg.client.enable (
        {
          ...
          flatten (mapAttrsToList (n: o: o.clientAuthorizations)
