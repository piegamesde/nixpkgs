...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.zfs-replication = {
      ...
      serviceConfig.ExecStart = "${pkgs.zfs-replicate}/bin/zfs-replicate${recursive} -l ${escapeShellArg cfg.username} -i ${escapeShellArg cfg.identityFilePath}${followDelete} ${
