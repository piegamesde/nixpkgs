...
in {
  ...
  options.services.kubernetes.kubelet = with lib.types; {
    ...
    address = mkOption {
      description =
        lib.mdDoc "Kubernetes kubelet info server listening address.";
      default = "0.0.0.0";
      type = str;
    };
    ...
    clientCaFile = mkOption {
      description =
        lib.mdDoc "Kubernetes apiserver CA file for client authentication.";
      default = top.caFile;
    ...
    cni = {
      ...
      configDir = mkOption {
        description =
          lib.mdDoc "Path to Kubernetes CNI configuration directory.";
        type = nullOr path;
        default = null;
      };
    };
    ...
    registerNode = mkOption {
      description =
        lib.mdDoc "Whether to auto register kubelet with API server.";
      default = true;
      type = bool;
    };
    ...
    tlsKeyFile = mkOption {
      description =
        lib.mdDoc "File containing x509 private key matching tlsCertFile.";
      default = null;
      type = nullOr path;
    };
