...
let
  ...
  peerUnitServiceName = interfaceName: peerName: dynamicRefreshEnabled:
    let refreshSuffix = optionalString dynamicRefreshEnabled "-refresh";
  ...
  generatePeerUnit = { interfaceName, interfaceCfg, peer }:
    let
      ...
      serviceName =
        peerUnitServiceName interfaceName peer.name dynamicRefreshEnabled;
  ...
  generateInterfaceTarget = name: values:
    let
      mkPeerUnit = peer:
        (peerUnitServiceName name peer.name
