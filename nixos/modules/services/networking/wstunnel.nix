...
let
  ...
  commonOptions = {
    ...
    autoStart = mkOption {
      description =
        mdDoc "Whether this tunnel server should be started automatically.";
      type = types.bool;
      default = true;
    };
  ...
  clientSubmodule =
    {
      ...
      options = commonOptions // {
        ...
        customHeaders = mkOption {
          description =
            mdDoc "Custom HTTP headers to send during the upgrade request.";
        ...
        serviceConfig =
          ...
          in
          {
            ...
            EnvironmentFile = optional
              (serverCfg.environmentFile != null)
    ...
    name: clientCfg: {
      ...
      value = {
        ...
        serviceConfig = {
          ...
          ExecStart = with clientCfg; ''
            ${package}/bin/wstunnel \
              ${
                concatStringsSep " " (
                  builtins.map
                  (x: "--localToRemote=${localRemoteToString x}")
                  localToRemote
                )
              } \
              ${
          ...
          '';
          EnvironmentFile = optional
            (clientCfg.environmentFile != null)
