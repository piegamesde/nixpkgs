  ...
  blockbookOpts =
    {
      ...
      options = {
        ...
        user = mkOption {
          ...
          description =
            lib.mdDoc "The user as which to run blockbook-frontend-${name}.";
        };
        ...
        group = mkOption {
          ...
          default = "${config.user}";
          description =
            lib.mdDoc "The group as which to run blockbook-frontend-${name}.";
        };
        ...
        configFile = mkOption {
          ...
          description =
            lib.mdDoc "Location of the blockbook configuration file.";
        };
        ...
        dataDir = mkOption {
          ...
          description =
            lib.mdDoc "Location of blockbook-frontend-${name} data directory.";
        };
        ...
        internal = mkOption {
          ...
          default = ":9030";
          description =
            lib.mdDoc "Internal http server binding `[address]:port`.";
        };
        ...
        public = mkOption {
          ...
          default = ":9130";
          description =
            lib.mdDoc "Public http server binding `[address]:port`.";
        };
...
in
{
  ...
  options = {
    services.blockbook-frontend = mkOption {
      ...
      default = { };
      description =
        lib.mdDoc "Specification of one or more blockbook-frontend instances.";
    };
  };
  ...
  config = mkIf (eachBlockbook != { }) {
    ...
    users.groups = mapAttrs'
      (instanceName: cfg: (nameValuePair "${cfg.group}" { }))
      eachBlockbook;
  };
