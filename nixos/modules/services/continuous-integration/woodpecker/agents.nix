  ...
  agentModule = lib.types.submodule {
    options = {
      enable = lib.mkEnableOption (lib.mdDoc
        "this Woodpecker-Agent. Agents execute tasks generated by a Server, every install will need one server and at least one agent");
      ...
      environment = lib.mkOption {
        ...
        description = lib.mdDoc
          "woodpecker-agent config environment variables, for other options read the [documentation](https://woodpecker-ci.org/docs/administration/agent-config)";
      };
