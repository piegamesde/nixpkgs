  ...
  config = mkMerge [
    ...
    (mkIf cfg.useNetworkd {
      ...
      systemd.network = mkMerge [
        ...
        interfaceNetworks
        (mkMerge (flip mapAttrsToList cfg.bridges (
          name: bridge: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
            ...
            networks = listToAttrs (forEach bridge.interfaces (
              bi:
        ...
        (mkMerge (flip mapAttrsToList cfg.bonds (
          name: bond: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
            ...
            networks = listToAttrs (forEach bond.interfaces (
              bi:
              nameValuePair "40-${bi}" (mkMerge [
                (genericNetwork (mkOverride 999))
                {
        ...
        (mkMerge (flip mapAttrsToList cfg.macvlans (
          name: macvlan: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
        ...
        (mkMerge (flip mapAttrsToList cfg.fooOverUDP (
          name: fou: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
        ...
        (mkMerge (flip mapAttrsToList cfg.sits (
          name: sit: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
        ...
        (mkMerge (flip mapAttrsToList cfg.greTunnels (
          name: gre: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
        ...
        (mkMerge (flip mapAttrsToList cfg.vlans (
          name: vlan: {
            netdevs."40-${name}" = {
              netdevConfig = {
                Name = name;
        ...
        let
          ...
          createVswitchDevice =
            ...
            nameValuePair "${n}-netdev" (
              let
                deps = map subsystemDevice (attrNames
