          ...
          in
          {
            ...
            auth = autoOrderRules (
              [
                ...
                {
                  name = "ssh_agent_auth";
                  enable = config.security.pam.enableSSHAgentAuth && cfg.sshAgentAuth;
                  control = "sufficient";
                ...
                )
                {
                  ...
                  enable = cfg.usbAuth;
                  control = "sufficient";
                  modulePath = "${pkgs.pam_usb}/lib/security/pam_usb.so";
                }
                (
                  let
              ...
              ++
                ...
                (optionals
                  ...
                  [
                    ...
                    {
                      name = "kwallet5";
                      enable = cfg.enableKwallet;
                      control = "optional";
                      modulePath = "${pkgs.plasma5Packages.kwallet-pam}/lib/security/pam_kwallet5.so";
                      settings = {
            ...
            session = autoOrderRules [
              ...
              {
                name = "cgfs";
                enable = config.virtualisation.lxc.lxcfs.enable;
                control = "optional";
                modulePath = "${pkgs.lxc}/lib/security/pam_cgfs.so";
                args = [
                  "-c"
                  "all"
                ];
