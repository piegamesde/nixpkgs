...
in {
  ...
  config = {
    systemd.additionalUpstreamSystemUnits = [
      ...
      config.systemd.package.withImportd [ "dbus-org.freedesktop.import1.service" ]
      ++ optionals
      config.systemd.package.withMachined [ "dbus-org.freedesktop.machine1.service" ]
      ++ optionals
      config.systemd.package.withPortabled [ "dbus-org.freedesktop.portable1.service" ]
      ++ [
