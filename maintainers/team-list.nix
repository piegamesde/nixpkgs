...
with lib.maintainers; {
  ...
  geospatial = {
    members = [ imincik sikmir nh2 willcohen ];
  ...
  matrix = {
    members = [ ma27 fadenb mguentner ralith dandellion sumnerevans ];
    scope = "Maintain the ecosystem around Matrix, a decentralized messenger.";
    shortName = "Matrix";
  };

  minimal-bootstrap = {
    members = [ artturin emilytrau ericson2314 jk ];
  ...
  node = {
    members = [ lilyinstarlight marsam winter ];
