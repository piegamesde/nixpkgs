...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://github.com/exactassembly/meta-xa-stm/raw/f96cf6e13f3c9c980f5651510dd96279b9b2af4f/recipes-support/lsiutil/files/lsiutil-${version}.tar.gz";
  ...
  meta = with lib; {
    homepage =
      "https://github.com/exactassembly/meta-xa-stm/tree/master/recipes-support/lsiutil/files";
    description =
