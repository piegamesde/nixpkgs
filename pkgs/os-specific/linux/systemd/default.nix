...
in stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/systemd/systemd/commit/3ed1d966f00b002ed822ca9de116252bd91fe6c3.patch";
  ...
  '' + (let
    ...
    dlopenLibs = let opt = condition: pkg: if condition then pkg else null;
    in [
    ...
    patchDlOpen = dl:
      let library = "${lib.makeLibraryPath [ dl.pkg ]}/${dl.name}";
