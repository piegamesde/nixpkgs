...
#
{
  busybox = import <nix/fetchurl.nix> {
    url =
      "http://tarballs.nixos.org/stdenv-linux/mips64el/ef3fe254f3c59455386bc92fe84164f9679b92b1/busybox"
      ;
  ...
  bootstrapTools = import <nix/fetchurl.nix> {
    url =
      "http://tarballs.nixos.org/stdenv-linux/mips64el/ef3fe254f3c59455386bc92fe84164f9679b92b1/bootstrap-tools.tar.xz"
      ;
