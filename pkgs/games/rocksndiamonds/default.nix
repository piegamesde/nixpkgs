...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://www.artsoft.org/RELEASES/unix/${pname}/rocksndiamonds-${version}.tar.gz";
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://git.artsoft.org/?p=rocksndiamonds.git;a=patch;h=b4271393b10b7c664a58f3db7349a3875c1676fe";
      sha256 = "0bdy4d2ril917radmm0c2yh2gqfyh7q1c8kahig5xknn2rkf2iac";
    })
    (fetchpatch {
      name = "fno-common-p2.patch";
      url =
        "https://git.artsoft.org/?p=rocksndiamonds.git;a=patch;h=81dbde8a570a94dd2e938eff2f52dc5a3ecced21";
