...
stdenv.mkDerivation rec {
  ...
  src = fetchzip {
    url =
      "https://downloads.sourceforge.net/project/hexahop/${version}/hex-a-hop-${version}.tar.gz";
  ...
  icon = fetchurl {
    ...
    url =
      "https://sourceforge.net/p/hexahop/code/ci/dfa365a90be5c52ef21235a9e90a865b04da3ad4/tree/data/hex-a-hop.png?format=raw";
  ...
  desktop = fetchurl {
    ...
    url =
      "https://sourceforge.net/p/hexahop/code/ci/e67385078e4f248a3877ee1066613d231c0d0eee/tree/data/hex-a-hop.desktop?format=raw";
