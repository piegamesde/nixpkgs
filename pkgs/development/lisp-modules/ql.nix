    ...
    (
      self: super: {
        ...
        cl-cffi-gtk-gdk-pixbuf =
          super.cl-cffi-gtk-gdk-pixbuf.overrideLispAttrs (
        ...
        cl-rabbit = super.cl-rabbit.overrideLispAttrs (
          o: {
        ...
        sdl2 =
          super.sdl2.overrideLispAttrs (o: { nativeLibs = [ pkgs.SDL2 ]; });
        ...
        cl-ana_dot_hdf-cffi = super.cl-ana_dot_hdf-cffi.overrideLispAttrs (
          o: {
        ...
        gsll = super.gsll.overrideLispAttrs (
          o: {
        ...
        pzmq-compat = super.pzmq-compat.overrideLispAttrs (
          o: {
            nativeBuildInputs = [ pkgs.zeromq ];
            nativeLibs = [ pkgs.zeromq ];
          }
        );
        pzmq-examples = super.pzmq-examples.overrideLispAttrs (
          o: {
            nativeBuildInputs = [ pkgs.zeromq ];
            nativeLibs = [ pkgs.zeromq ];
          }
        );
        pzmq-test = super.pzmq-test.overrideLispAttrs (
          o: {
            nativeBuildInputs = [ pkgs.zeromq ];
            nativeLibs = [ pkgs.zeromq ];
          }
