...
{ cmdLineToolsVersion ? "9.0", toolsVersion ? "26.1.1"
, platformToolsVersion ? "34.0.1", buildToolsVersions ? [ "33.0.2" ]
, includeEmulator ? false, emulatorVersion ? "33.1.6", platformVersions ? [ ]
, includeSources ? false, includeSystemImages ? false
, systemImageTypes ? [ "google_apis_playstore" ]
, abiVersions ? [ "armeabi-v7a" "arm64-v8a" ], cmakeVersions ? [ ]
, includeNDK ? false, ndkVersion ? "25.2.9519653", ndkVersions ? [ ndkVersion ]
    ...
    if lib.hasAttrByPath [ package version ] packages then
      ...
      throw ''
        ...
        The only available versions are ${
          ...
          (builtins.attrNames packages.${package})
        }.
      '';
