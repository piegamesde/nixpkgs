  ...
  final: prev: {
    ...
    bitwarden-cli = prev."@bitwarden/cli".override {
      ...
      nativeBuildInputs = with pkgs;
        ...
        stdenv.isDarwin [ darwin.apple_sdk.frameworks.CoreText ];
      buildInputs = with pkgs; [
        pixman
        cairo
        pango
    ...
    mermaid-cli = prev."@mermaid-js/mermaid-cli".override (if
      stdenv.isDarwin
    then
      { }
    else {
    ...
    uppy-companion =
      prev."@uppy/companion".override { name = "uppy-companion"; };
