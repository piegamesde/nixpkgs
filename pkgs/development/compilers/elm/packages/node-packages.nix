...
in
{
  ...
  create-elm-app = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."@types/uglify-js-3.17.3" // { dependencies = [ sources."source-map-0.6.1" ]; })
      (sources."@types/webpack-4.41.35" // { dependencies = [ sources."source-map-0.6.1" ]; })
      (sources."@types/webpack-sources-3.2.2" // { dependencies = [ sources."source-map-0.7.4" ]; })
  ...
  elm-pages = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."path-is-absolute-1.0.1"
      sources."path-key-3.1.1"
      (sources."path-scurry-1.10.1" // { dependencies = [ sources."lru-cache-10.0.1" ]; })
      sources."path-to-regexp-0.1.7"
      sources."path-type-4.0.0"
      sources."picocolors-1.0.0"
      sources."picomatch-2.3.1"
      ...
      (sources."terser-5.24.0" // { dependencies = [ sources."commander-2.20.3" ]; })
      sources."tmp-0.0.33"
      sources."to-readable-stream-1.0.0"
      sources."to-regex-range-5.0.1"
      sources."toidentifier-1.0.1"
