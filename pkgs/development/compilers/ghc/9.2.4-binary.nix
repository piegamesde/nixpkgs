    ...
    defaultLibc = {
      i686-linux = {
        ...
        src = {
          ...
          sha256 =
            "5dc1eb9c65f01b1e5c5693af72af07a4e9e75c6920e620fd598daeefa804487a";
        };
...
stdenv.mkDerivation rec {
  ...
  configurePlatforms = [ ];
  configureFlags = [ "--with-gmp-includes=${lib.getDev gmpUsed}/include"
  ...
  # find editline/gmp.
  postFixup =
    lib.optionalString (stdenv.isLinux && !(binDistUsed.isStatic or false)) (if
