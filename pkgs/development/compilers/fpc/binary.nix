...
stdenv.mkDerivation rec {
  ...
  src = if stdenv.hostPlatform.system == "i686-linux" then
    fetchurl {
      ...
      sha256 =
        "f62980ac0b2861221f79fdbff67836aa6912a4256d4192cfa4dfa0ac5b419958";
    }
  else if stdenv.hostPlatform.system == "x86_64-linux" then
    fetchurl {
      url =
        "mirror://sourceforge/project/freepascal/Linux/${version}/fpc-${version}.x86_64-linux.tar";
      sha256 =
    ...
    fetchurl {
      url =
        "mirror://sourceforge/project/freepascal/Linux/${version}/fpc-${version}.aarch64-linux.tar";
      sha256 =
        "b39470f9b6b5b82f50fc8680a5da37d2834f2129c65c24c5628a80894d565451";
    }
  else if stdenv.isDarwin then
    fetchurl {
      url =
        "mirror://sourceforge/project/freepascal/Mac%20OS%20X/${version}/fpc-${version}.intelarm64-macosx.dmg";
      sha256 =
