...
, cmake, darwin, ninja, python3, libffi
, enableGoldPlugin ? (!stdenv.isDarwin && !stdenv.targetPlatform.isWasi), libbfd
, libpfm, libxml2, ncurses, version, release_version, zlib, which, sysctl
, buildLlvmTools, debugVersion ? false, doCheck ? (!stdenv.isx86_32 # TODO: why
