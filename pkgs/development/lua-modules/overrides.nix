...
with prev; {
  ...
  ##########################################3
  bit32 = prev.bit32.overrideAttrs (
    oa: {
  ...
  ljsyscall = prev.ljsyscall.overrideAttrs (
    oa: rec {
  ...
  luadbi-mysql = prev.luadbi-mysql.overrideAttrs (
    oa: {
      extraVariables = {
  ...
  luaossl = prev.luaossl.overrideAttrs (
    _: {
      externalDeps = [
        {
          name = "CRYPTO";
  ...
  lua-rtoml = prev.lua-rtoml.overrideAttrs (
    oa: {
  ...
  magick = prev.magick.overrideAttrs (
    oa: {
  ...
  toml-edit = prev.toml-edit.overrideAttrs (
    oa: {
