...
, cudaPackages, magma, useSystemNccl ? true, MPISupport ? false, mpi
, buildDocs ? false,
...
in assert cudaSupport -> stdenv.isLinux;
...
in buildPythonPackage rec {
  ...
  nativeBuildInputs =
    [ cmake which ninja pybind11 pythonRelaxDepsHook removeReferencesTo ]
