...
builtins.getAttr version {
  "2.0.1" = {
    ...
    aarch64-linux-311 = {
      ...
      url =
        "https://download.pytorch.org/whl/torch-2.0.1-cp311-cp311-manylinux2014_aarch64.whl";
