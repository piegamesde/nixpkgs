{ lib, buildPythonPackage, fetchPypi, future, mock, parameterized
, pytestCheckHook, python-dateutil, pythonOlder, six }:
...
buildPythonPackage rec {
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/vertica/vertica-python/releases/tag/${version}";
