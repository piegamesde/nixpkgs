{ lib, stdenv, buildPythonPackage, cargo, datasets, fetchFromGitHub, fetchurl
, libiconv, numpy, openssl, pkg-config, pytestCheckHook, pythonOlder, requests
, rustPlatform, rustc, Security, setuptools-rust }:
...
in buildPythonPackage rec {
  ...
  nativeBuildInputs =
    [ pkg-config setuptools-rust rustPlatform.cargoSetupHook cargo rustc ];
