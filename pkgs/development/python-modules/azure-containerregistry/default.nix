...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ azure-core msrest msrestazure isodate ];
  ...
  meta = with lib; {
    ...
    homepage =
      "https://github.com/Azure/azure-sdk-for-python/tree/main/sdk/containerregistry/azure-containerregistry";
