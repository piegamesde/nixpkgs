{ lib, buildPythonPackage, fetchFromGitHub, lxml, matplotlib, numpy
, pytestCheckHook, scikit-image, scikit-learn }:

let rev = "9a016380625927f385e699664026c90356557850";
in buildPythonPackage {
  ...
  propagatedBuildInputs = [ lxml numpy scikit-image scikit-learn matplotlib ];
