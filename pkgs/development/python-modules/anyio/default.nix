...
# dependencies
, exceptiongroup, idna, sniffio

# optionals
, trio

# tests
, hypothesis, psutil, pytest-mock, pytest-xdist, pytestCheckHook, trustme
, uvloop }:
...
buildPythonPackage rec {
  ...
  passthru.optional-dependencies = { trio = [ trio ]; };
  ...
  pytestFlagsArray =
    [ "-W" "ignore::trio.TrioDeprecationWarning" "-m" "'not network'" ];
