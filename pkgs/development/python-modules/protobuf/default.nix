...
buildPythonPackage {
  ...
  patches =
    ...
    ++ lib.optionals
      (pythonAtLeast "3.11" && lib.versionOlder protobuf.version "3.22")
      [
        (fetchpatch {
  ...
  nativeCheckInputs = [
    pytestCheckHook
  ] ++ lib.optionals (lib.versionAtLeast protobuf.version "3.22") [ numpy ];
  ...
  disabledTestPaths =
    lib.optionals (lib.versionAtLeast protobuf.version "3.23")
      [
