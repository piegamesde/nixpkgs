{ self, bash, fetchpatch, fzf, lib, openssl, zstd }:
...

{
  ...
  async_rpc_websocket = janePackage {
    ...
    propagatedBuildInputs =
      [ async_rpc_kernel async_websocket cohttp_async_websocket ];
  };
  ...
  base_quickcheck = janePackage {
    ...
    propagatedBuildInputs =
      [ ppx_base ppx_fields_conv ppx_let ppx_sexp_value splittable_random ];
  };
  ...
  core = janePackage {
    ...
    propagatedBuildInputs =
      [ base base_bigstring base_quickcheck ppx_jane time_now ];
  ...
  ppx_css = janePackage {
    ...
    propagatedBuildInputs =
      [ core_kernel ppxlib js_of_ocaml js_of_ocaml-ppx sedlex ];
  };
  ...
  ppx_log = janePackage {
    ...
    propagatedBuildInputs =
      [ base ppx_here ppx_sexp_conv ppx_sexp_message sexplib ];
  };
  ...
  vcaml = janePackage {
    ...
    propagatedBuildInputs =
      [ angstrom-async async_extra expect_test_helpers_async faraday ];
  };
