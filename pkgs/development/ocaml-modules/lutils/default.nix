...
buildDunePackage rec {
  ...
  src = fetchurl {
    url =
      "http://www-verimag.imag.fr/DIST-TOOLS/SYNCHRONE/pool/lutils.v${version}.tgz";
    hash =
  ...
  meta = with lib; {
    ...
    changelog =
      "https://gricad-gitlab.univ-grenoble-alpes.fr/verimag/synchrone/lutils/-/releases/v${version}";
