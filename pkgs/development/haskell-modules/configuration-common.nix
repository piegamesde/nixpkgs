...
self: super:
{
  ...
  Cabal_3_10_2_0 = doDistribute (
    super.Cabal_3_10_2_0.override (
      {
  ...
  monad-bayes = dontCheck (
    doJailbreak (super.monad-bayes.override { hspec = self.hspec_2_11_6; })
  );
  ...
  hnix = appendPatches [ ./patches/hnix-compat-for-ghc-9.4.patch ] (
  ...
  hnix-store-core_0_6_1_0 = doDistribute (
    doJailbreak super.hnix-store-core_0_6_1_0
  );
  ...
  hspec_2_11_6 = doDistribute (
    super.hspec_2_11_6.override {
      hspec-discover = self.hspec-discover_2_11_6;
      hspec-core = self.hspec-core_2_11_6;
    }
  );
  hspec-meta_2_11_6 = doDistribute (
    super.hspec-meta_2_11_6.override {
      hspec-expectations = self.hspec-expectations_0_8_4;
    }
  );
  hspec-discover_2_11_6 = doDistribute (
    super.hspec-discover_2_11_6.override { hspec-meta = self.hspec-meta_2_11_6; }
  );
  # Need to disable tests to prevent an infinite recursion if hspec-core_2_11_6
  # is overlayed to hspec-core.
  hspec-core_2_11_6 = doDistribute (
    dontCheck (
      super.hspec-core_2_11_6.override {
        hspec-expectations = self.hspec-expectations_0_8_4;
      }
    )
  );
  ...
  inherit
    (
      ...
      in
      {
        ...
        pandoc_3_1_8 = doDistribute (
          super.pandoc_3_1_8.overrideScope pandoc-cli-overlay
        );
  ...
  haskell-ci = doJailbreak (
    super.haskell-ci.overrideScope (
      self: super: { Cabal-syntax = self.Cabal-syntax_3_10_2_0; }
    )
  );
  ...
  digits =
    overrideCabal (drv: { preCompileBuildDriver = "rm Setup.lhs"; })
      super.digits;
  ...
  sdl2-gfx =
    overrideCabal { __propagatePkgConfigDepends = false; }
      super.sdl2-gfx;
  sdl2-ttf =
