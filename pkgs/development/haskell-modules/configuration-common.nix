...
self: super:
{
    ...
    overrideCabal
      ...
      (
        super.sensei.override {
          ...
          hspec-contrib = self.hspec-contrib.override { hspec-core = self.hspec-core_2_11_1; };
  ...
  hspec_2_11_1 = doDistribute (
    super.hspec_2_11_1.override {
      hspec-discover = self.hspec-discover_2_11_1;
      hspec-core = self.hspec-core_2_11_1;
    }
  );
  hspec-discover_2_11_1 = doDistribute (
    super.hspec-discover_2_11_1.override { hspec-meta = self.hspec-meta_2_10_5; }
  );
  # Need to disable tests to prevent an infinite recursion if hspec-core_2_11_1
  # is overlayed to hspec-core.
  hspec-core_2_11_1 = doDistribute (
    dontCheck (
  ...
  swarm = doJailbreak (super.swarm.override { brick = doJailbreak (dontCheck super.brick_1_9); });
  ...
  fourmolu_0_12_0_0 = dontCheck (
    super.fourmolu_0_12_0_0.overrideScope (
      lself: lsuper: {
