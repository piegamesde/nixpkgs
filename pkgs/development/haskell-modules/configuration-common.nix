...
self: super:
{
  ...
  monad-bayes = dontCheck (doJailbreak (super.monad-bayes.override { hspec = self.hspec_2_11_6; }));
  ...
  hspec-meta_2_11_6 = doDistribute (
    super.hspec-meta_2_11_6.override { hspec-expectations = self.hspec-expectations_0_8_4; }
  );
  ...
  hspec-core_2_11_6 = doDistribute (
    dontCheck (super.hspec-core_2_11_6.override { hspec-expectations = self.hspec-expectations_0_8_4; })
  );
