...
builtins.intersectAttrs super {
  ...
  inherit
    (pkgs.lib.mapAttrs (_: dontCheck) super)
  ...
  sfml-audio = appendConfigureFlag
  ...
  digitalocean-kzs = dontCheck super.digitalocean-kzs
  ...
  marmalade-upload = dontCheck super.marmalade-upload
  ...
  slack-api = dontCheck super.slack-api
  ...
  servant-client-core =
    if (pkgs.lib.getVersion super.servant-client-core) == "0.16" then
      appendPatch
      ./patches/servant-client-core-redact-auth-header.patch
  ...
  aeson-typescript = overrideCabal
    (drv: {
      testToolDepends =
  ...
  fourmolu = overrideCabal
    ...
    # Test suite wants to run main executable
  fourmolu_0_10_1_0 = overrideCabal
    (drv: {
      preCheck =
        drv.preCheck or ""
        + ''
  ...
  http-api-data-qq = overrideCabal
    (drv: {
      testFlags =
        [
          "-p"
