  ...
  let
    ...
    defaultConfigureFlags = [
      ...
      stdenv.hasCC [ "--with-gcc=$CC" # Clang won't work without that extra information.
        ...
        ghc.version)) [ "--ghc-option=-split-sections" ]
      ++ optionals dontStrip [
    ...
    setupCompileFlags = [
      (optionalString (!coreSetup)
        "-${nativePackageDbFlag}=$setupPackageConfDir")
        ...
        passthru = passthru // rec {
          ...
          getCabalDeps = {
            inherit buildDepends buildTools executableFrameworkDepends
              ...
              libraryFrameworkDepends libraryHaskellDepends
              libraryPkgconfigDepends librarySystemDepends libraryToolDepends
              pkg-configDepends setupHaskellDepends;
          ...
          getBuildInputs = rec {
            ...
            isHaskellPartition = lib.partition isHaskellPkg
              (propagatedBuildInputs ++ otherBuildInputs ++ depsBuildBuild
                ++ nativeBuildInputs);
          };
