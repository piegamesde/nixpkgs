...
rec {
  ...
  */
  ...
  appendBuildFlags =
    drv: xs:
    compose.appendBuildFlags xs drv
    ;
  ...
  disableHardening =
    drv: flags:
    compose.disableHardening flags drv
    ;
