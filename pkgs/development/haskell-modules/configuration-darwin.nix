...
(
  {
    ...
    yesod-bin =
      addBuildDepend darwin.apple_sdk.frameworks.Cocoa super.yesod-bin;

    hmatrix =
      addBuildDepend darwin.apple_sdk.frameworks.Accelerate super.hmatrix;
    ...
    aws-cloudfront-signed-cookies =
      dontCheck super.aws-cloudfront-signed-cookies;
