{ lib, rustPlatform, fetchCrate, fetchpatch, stdenv }:
...
rustPlatform.buildRustPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/facebookexperimental/starlark-rust/commit/0e4f90c77868e506268fcb6c9d37368e5b2b8cf5.patch";
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/facebookexperimental/starlark-rust/blob/v${version}/CHANGELOG.md";
