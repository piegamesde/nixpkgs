...
{ lib, lua, wrapLua, luarocks

# Whether the derivation provides a lua module or not.
, luarocksCheckHook, luaLib }:
...
, dontWrapLuaPrograms ? false, doCheck ? false
...
let
  ...
  luarocksDrv = luaLib.toLuaModule (lua.stdenv.mkDerivation (self:
    attrs // {
      ...
      nativeBuildInputs = [ wrapLua luarocks ];
      ...
      in [ lua.pkgs.luarocks ] ++ buildInputs ++ lib.optionals self.doCheck
