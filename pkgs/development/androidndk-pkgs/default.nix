    ...
    import ./androidndk-pkgs.nix {
      ...
      targetAndroidndkPkgs =
        if targetPackages ? androidndkPkgs_21 then
          ...
          throw
            "androidndkPkgs_21: no targetPackages, use `buildPackages.androidndkPkgs_21";
    };
    ...
    import ./androidndk-pkgs.nix {
      ...
      targetAndroidndkPkgs =
        if targetPackages ? androidndkPkgs_23b then
          ...
          throw
            "androidndkPkgs_23b: no targetPackages, use `buildPackages.androidndkPkgs_23b";
    };
    ...
    import ./androidndk-pkgs.nix {
      ...
      targetAndroidndkPkgs =
        if targetPackages ? androidndkPkgs_24 then
          ...
          throw
            "androidndkPkgs_24: no targetPackages, use `buildPackages.androidndkPkgs_24";
    };
}
