...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://sourceware.org/git/?p=binutils-gdb.git;a=patch;h=2e977d9901393ea1bacbe1896af0929e968bc811";
  ...
  buildInputs =
    [ ncurses readline gmp mpfr expat libipt zlib zstd guile sourceHighlight ]
