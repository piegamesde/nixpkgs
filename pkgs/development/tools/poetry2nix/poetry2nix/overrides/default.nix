  ...
  addBuildSystem = { self, drv, attr, extraAttrs ? [ ] }:
    let
      buildSystem = if builtins.isAttrs attr then
        ...
        in if fromIsValid && untilIsValid then intendedBuildSystem else null
    ...
    in (
      ...
      if (attr == "flit-core" || attr == "flit" || attr == "hatchling")
      && !self.isPy3k then
        drv
...
in lib.composeManyExtensions [
  ...
  # Add build systems
  (self: super:
    let buildSystems = lib.importJSON ./build-systems.json;
    in lib.mapAttrs (attr: systems:
      builtins.foldl' (drv: attr: addBuildSystem { inherit drv self attr; })
      super.${attr} systems) buildSystems)
  ...
  (self: super:
    let
      ...
      selectQt5 = version:
        ...
        in pkgs."qt${selector}" or pkgs.qt5;
    ...
    in {
      ...
      aiohttp-swagger3 = super.aiohttp-swagger3.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pytest-runner ];
      });
      ...
      ansible-base = super.ansible-base.overridePythonAttrs (old:
        {
          prePatch =
      ...
      ansible-lint = super.ansible-lint.overridePythonAttrs (old: {
      ...
      argcomplete = super.argcomplete.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.importlib-metadata ];
      });

      arpeggio = super.arpeggio.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pytest-runner ];
      });
      ...
      av = super.av.overridePythonAttrs (old: {
        ...
        getCargoHash = version:
          {
            ...
            lib.fakeHash);
      in super.bcrypt.overridePythonAttrs (old:
        {
          buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.libffi ]
            ++ lib.optionals
            (lib.versionAtLeast old.version "4" && stdenv.isDarwin) [
      ...
      bjoern = super.bjoern.overridePythonAttrs (old: {
      ...
      cairocffi = super.cairocffi.overridePythonAttrs (old: {
        inherit (pkgs.python3.pkgs.cairocffi) patches;
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
      });

      cairosvg = super.cairosvg.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
      });

      cattrs = let drv = super.cattrs;
      ...
      cssselect2 = super.cssselect2.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
      });
      ...
      cmdstanpy = super.cmdstanpy.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.cmdstan ];
        patchPhase = ''
      ...
      cloudflare = super.cloudflare.overridePythonAttrs (old: {
        postPatch = ''
          rm -rf examples/*
        '';
      });
      ...
      confluent-kafka = super.confluent-kafka.overridePythonAttrs
        (old: { buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.rdkafka ]; });
      ...
      cryptography = let
        ...
        scrypto = if isWheel then
          ...
          super.cryptography;
      in scrypto.overridePythonAttrs (old:
        {
          nativeBuildInputs = (old.nativeBuildInputs or [ ])
        ...
        (lib.versionAtLeast old.version "3.5" && !isWheel) rec {
          cargoDeps = pkgs.rustPlatform.fetchCargoTarball {
            src = old.src;
      ...
      dbt-extractor = super.dbt-extractor.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ pkgs.cargo pkgs.rustc pkgs.maturin ];
      });
      ...
      dictdiffer = super.dictdiffer.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ self.setuptools ];
      });
      ...
      django-bakery = super.django-bakery.overridePythonAttrs (old: {
        configurePhase = ''
      ...
      django-hijack = super.django-hijack.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pytest-runner ];
      });

      django-prometheus = super.django-prometheus.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pytest-runner ];
      });

      django-rosetta = super.django-rosetta.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pytest-runner ];
      });

      django-stubs-ext = super.django-stubs-ext.overridePythonAttrs
        (old: { prePatch = (old.prePatch or "") + "touch ../LICENSE.txt"; });

      dlib = super.dlib.overridePythonAttrs (old: {
        ...
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ pkgs.dlib.nativeBuildInputs;
        buildInputs = (old.buildInputs or [ ]) ++ pkgs.dlib.buildInputs;
      });

      # Setuptools >= 60 broke build_py_2to3
      docutils = if lib.versionOlder super.docutils.version "0.16"
      && lib.versionAtLeast super.setuptools.version "60" then
      ...
      flatbuffers =
        super.flatbuffers.overrideAttrs (old: { VERSION = old.version; });
      ...
      in super.gdal.overridePythonAttrs (old: {
      ...
      grandalf = super.grandalf.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
        doCheck = false;
      });
      ...
      in super.granian.overridePythonAttrs (old: rec {
      ...
      grpcio = super.grpcio.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkg-config ];
        buildInputs = (old.buildInputs or [ ])
          ++ [ pkgs.c-ares pkgs.openssl pkgs.zlib ];
        ...
        if old.format != "wheel" then
          ...
          in {
            nativeBuildInputs = (old.nativeBuildInputs or [ ])
              ++ [ pkg-config ];
            buildInputs = (old.buildInputs or [ ])
              ++ [ pkgs.hdf5 self.pkgconfig ] ++ lib.optional mpiSupport mpi;
            propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
      ...
      hikari-lightbulb = super.hikari-lightbulb.overrideAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.setuptools ];
      });

      horovod = super.horovod.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.mpi ];
      });
      ...
      imagecodecs = super.imagecodecs.overridePythonAttrs (old: {
        patchPhase = ''
          substituteInPlace setup.py \
      ...
      intreehooks =
        super.intreehooks.overridePythonAttrs (old: { doCheck = false; });
      ...
      jaraco-functools = super.jaraco-functools.overridePythonAttrs (old: {
      ...
      jira = super.jira.overridePythonAttrs (old: {
      ...
      jupyter = super.jupyter.overridePythonAttrs (old: {
      ...
      lap = super.lap.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ self.numpy ];
      });
      ...
      lxml = super.lxml.overridePythonAttrs (old: {
        ...
        buildInputs = with pkgs;
          (old.buildInputs or [ ]) ++ [ libxml2 libxslt ];
      });

      markupsafe = super.markupsafe.overridePythonAttrs (old: {
        src = old.src.override {
          pname =
            builtins.replaceStrings [ "markupsafe" ] [ "MarkupSafe" ] old.pname;
        };
      });
      ...
      matplotlib = super.matplotlib.overridePythonAttrs (old:
        ...
        in {
          ...
          propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
            ++ [ self.certifi pkgs.libpng pkgs.freetype qhull ]
          ...
          nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkg-config ]
            ++ lib.optionals
            (lib.versionAtLeast super.matplotlib.version "3.5.0") [
              self.setuptools-scm
              self.setuptools-scm-git-archive
            ];
          ...
          in lib.optionalString enableTk ''
      ...
      mip = super.mip.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ pkgs.autoPatchelfHook ];
      ...
      mypy = super.mypy.overridePythonAttrs (old:
        {
          buildInputs = (old.buildInputs or [ ])
            ++ [ self.types-typed-ast self.types-setuptools ]
      ...
      netcdf4 = super.netcdf4.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.zlib pkgs.netcdf pkgs.hdf5 pkgs.curl pkgs.libjpeg ];
      ...
      _opencv-python-override = old: {
        ...
        nativeBuildInputs = [ pkgs.cmake ] ++ old.nativeBuildInputs;
        buildInputs = [ self.scikit-build ] ++ lib.optionals stdenv.isDarwin
      ...
      opencv-python =
        super.opencv-python.overridePythonAttrs self._opencv-python-override;
      ...
      openvino = super.openvino.overridePythonAttrs (old: {
        buildInputs =
          [ pkgs.ocl-icd pkgs.hwloc pkgs.tbb pkgs.numactl pkgs.libxml2 ]
          ++ (old.buildInputs or [ ]);
      });
        ...
        getCargoHash = version:
          {
            ...
            lib.fakeHash);
      in super.orjson.overridePythonAttrs (old: {
        cargoDeps = pkgs.rustPlatform.fetchCargoTarball {
          inherit (old) src;
          name = "${old.pname}-${old.version}";
      ...
      osqp = super.osqp.overridePythonAttrs (old: {
      ...
      parsel = super.parsel.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pytest-runner ];
      });
      ...
      peewee = super.peewee.overridePythonAttrs (old:
        let
      ...
      pillow = super.pillow.overridePythonAttrs (old:
        ...
        in {
          ...
          buildInputs = with pkgs;
            ...
            [ xorg.libxcb ] ++ lib.optionals (self.isPyPy) [ tk xorg.libX11 ];
      ...
      portend = super.portend.overridePythonAttrs (old: {
        # required for the extra "toml" dependency in setuptools_scm[toml]
        buildInputs = (old.buildInputs or [ ]) ++ [ self.toml ];
      });
      ...
      prophet = super.prophet.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.cmdstan self.cmdstanpy ];
        PROPHET_REPACKAGE_CMDSTAN = "false";
        CMDSTAN = "${pkgs.cmdstan}";
      });

      psycopg2 = super.psycopg2.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ])
      ...
      psycopg2cffi = super.psycopg2cffi.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ])
          ++ lib.optional stdenv.isDarwin pkgs.openssl;
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ pkgs.postgresql ];
      ...
      py-solc-x = super.py-solc-x.overridePythonAttrs (old: {
        ...
        '';
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ self.requests self.semantic-version ];
      });

      pyarrow = if (!super.pyarrow.src.isWheel or false)
      && lib.versionAtLeast super.pyarrow.version "0.16.0" then
        super.pyarrow.overridePythonAttrs (old:
          let
            parseMinor = drv:
              lib.concatStringsSep "."
              (lib.take 2 (lib.splitVersion drv.version));
            ...
            _arrow-cpp = pkgs.arrow-cpp.override (builtins.intersectAttrs
      ...
      pycairo = (drv:
        ...
        (old: {
          ...
          nativeBuildInputs = (old.nativeBuildInputs or [ ])
            ++ [ self.meson pkgs.ninja pkg-config ];
      ...
      pyfftw = super.pyfftw.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ])
          ++ [ pkgs.fftw pkgs.fftwFloat pkgs.fftwLongDouble ];
      });
      ...
      pygeos = super.pygeos.overridePythonAttrs (old: {
      ...
      pygobject = super.pygobject.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ pkg-config ];
        buildInputs = (old.buildInputs or [ ])
          ++ [ pkgs.glib pkgs.gobject-introspection ];
      });
      ...
      pymssql = super.pymssql.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.openssl pkgs.libkrb5 ];
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.freetds ];
      });

      pyopencl = super.pyopencl.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ self.numpy ];
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.ocl-icd pkgs.opencl-headers ];
      });

      pyopenssl = super.pyopenssl.overridePythonAttrs
        (old: { buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.openssl ]; });

      pyproj = super.pyproj.overridePythonAttrs (old: {
        PROJ_DIR = "${pkgs.proj}";
      ...
      python-bugzilla = super.python-bugzilla.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ]) ++ [ self.docutils ];
      });

      python-ldap = super.python-ldap.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ])
          ++ [ pkgs.openldap pkgs.cyrus_sasl ];
      });
      ...
      pyqt5 = let qt5 = selectQt5 super.pyqt5.version;
      in super.pyqt5.overridePythonAttrs (old: {
        postPatch = ''
          # Confirm license
        ...
        dontWrapQtApps = true;
        nativeBuildInputs = old.nativeBuildInputs or [ ]
          ++ [ self.pyqt-builder self.sip qt5.full ];
      });

      pyqt5-qt5 = let qt5 = selectQt5 super.pyqt5-qt5.version;
      in super.pyqt5-qt5.overridePythonAttrs (old: {
        dontWrapQtApps = true;
        propagatedBuildInputs = old.propagatedBuildInputs or [ ] ++ [
          qt5.full
      ...
      pytest-datadir = super.pytest-datadir.overridePythonAttrs (old: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });
      ...
      python-magic = super.python-magic.overridePythonAttrs (old: {
        postPatch = ''
          substituteInPlace magic/loader.py \
            --replace "'libmagic.so.1'" "'${
              lib.getLib pkgs.file
            }/lib/libmagic.so.1'"
        '';
      ...
      ffmpeg-python = super.ffmpeg-python.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
      });

      python-prctl = super.python-prctl.overridePythonAttrs
        (old: { buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.libcap ]; });

      pyudev = super.pyudev.overridePythonAttrs (old: {
        postPatch = ''
          substituteInPlace src/pyudev/_ctypeslib/utils.py \
            --replace "find_library(name)" "'${
      ...
      pywavelets = super.pywavelets.overridePythonAttrs (old: {
        HDF5_DIR = "${pkgs.hdf5}";
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ pkgs.hdf5 ];
      });
      ...
      recommonmark = super.rich.overridePythonAttrs (old: {
      ...
      rockset = super.rockset.overridePythonAttrs (old: {
        postPatch = ''
          cp ./setup_rockset.py ./setup.py
        '';
      });

      scaleapi = super.scaleapi.overridePythonAttrs (old: {
        postPatch = ''
          substituteInPlace setup.py --replace "install_requires = ['requests>=2.4.2', 'enum34']" "install_requires = ['requests>=2.4.2']" || true
        '';
      });

      panel = super.panel.overridePythonAttrs (old: {
      ...
      scikit-image = super.scikit-image.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ self.pythran self.packaging self.wheel self.numpy ];
      });

      scikit-learn = super.scikit-learn.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.gfortran ]
      ...
      secp256k1 = super.secp256k1.overridePythonAttrs (old: {
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ pkgs.pkgconfig pkgs.autoconf pkgs.automake pkgs.libtool ];
        buildInputs = (old.buildInputs or [ ]) ++ [ self.pytest-runner ];
        doCheck = false;
      ...
      in selenium.overridePythonAttrs (old: {
        # Selenium <4 can be installed from sources, with setuptools
        buildInputs = old.buildInputs
          ++ (lib.optionals (!v4orLater) [ self.setuptools ]);
      });
      ...
      tables = super.tables.overridePythonAttrs (old: {
        ...
        propagatedBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ pkgs.hdf5 self.numpy self.numexpr ];
      });

      tempora = super.tempora.overridePythonAttrs (old: {
        # required for the extra "toml" dependency in setuptools_scm[toml]
        buildInputs = (old.buildInputs or [ ]) ++ [ self.toml ];
      });

      tensorboard = super.tensorboard.overridePythonAttrs (old: {
        buildInputs = (old.buildInputs or [ ]) ++ [ self.wheel self.absl-py ];
        HDF5_DIR = "${pkgs.hdf5}";
        propagatedBuildInputs = (old.nativeBuildInputs or [ ]) ++ [
          pkgs.hdf5
      ...
      tensorpack = super.tensorpack.overridePythonAttrs (old: {
        postPatch = ''
        ...
        pkg.overrideAttrs (old: {
          ...
          preConfigure = if (enableCuda) then ''
            export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:${self.torch}/${self.python.sitePackages}/torch/lib:${
              lib.makeLibraryPath [ cudatoolkit "${cudatoolkit}" ]
            }"
          '' else ''
            export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:${self.torch}/${self.python.sitePackages}/torch/lib"
          '';
      ...
      urwidtrees = super.urwidtrees.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ self.urwid ];
      });

      vose-alias-method = super.vose-alias-method.overridePythonAttrs (old: {
        postInstall = ''
          rm -f $out/LICENSE
        '';
      });

      vispy = super.vispy.overrideAttrs (old: {
      ...
      in super.watchfiles.overridePythonAttrs (old: rec {
        src = pkgs.fetchFromGitHub {
          owner = "samuelcolvin";
          repo = "watchfiles";
          rev = "v${old.version}";
      ...
      in if (lib.versionAtLeast old.version "20.5"
        && lib.versionOlder old.version "20.8") then
        addBuildSystem {
          inherit self;
          drv = old;
          attr = "flit-core";
      ...
      sentencepiece = super.sentencepiece.overridePythonAttrs (old: {
        dontUseCmakeConfigure = true;
        nativeBuildInputs = (old.nativeBuildInputs or [ ])
          ++ [ pkg-config pkgs.cmake pkgs.gperftools ];
      ...
      supervisor = super.supervisor.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ self.meld3 self.setuptools ];
      });

      cytoolz = super.cytoolz.overridePythonAttrs (old: {
        propagatedBuildInputs = (old.propagatedBuildInputs or [ ])
          ++ [ self.toolz ];
      });
      ...
      watchdog = super.watchdog.overrideAttrs (old: {
        buildInputs = (old.buildInputs or [ ])
      ...
      minimal-snowplow-tracker =
        super.minimal-snowplow-tracker.overridePythonAttrs (old: {
          nativeBuildInputs = (old.nativeBuildInputs or [ ])
            ++ [ super.setuptools ];
        });
      ...
      wxpython = super.wxpython.overridePythonAttrs (old:
        let
          localPython =
            self.python.withPackages (ps: with ps; [ setuptools numpy six ]);
        in {
          DOXYGEN = "${pkgs.doxygen}/bin/doxygen";

          nativeBuildInputs = with pkgs;
            [ which doxygen gtk3 pkg-config autoPatchelfHook ]
            ++ (old.nativeBuildInputs or [ ]);
      ...
      uwsgi = super.uwsgi.overridePythonAttrs (old:
        ...
        } // lib.optionalAttrs (lib.versionAtLeast old.version "2.0.19"
          && lib.versionOlder old.version "2.0.20") { sourceRoot = "."; });
      ...
      nbconvert = let
        patchExporters = lib.optionalString
          (lib.versionAtLeast self.nbconvert.version "6.5.0") ''
            substituteInPlace \
              ...
              --subst-var out
          '';
      in super.nbconvert.overridePythonAttrs (old: {
        postPatch = lib.optionalString (!(old.src.isWheel or false))
          (patchExporters + lib.optionalString
            (lib.versionAtLeast self.nbconvert.version "7.0") ''
              substituteInPlace \
                ./hatch_build.py \
                --replace \
      ...
      in super.mkdocstrings.overridePythonAttrs (old:
