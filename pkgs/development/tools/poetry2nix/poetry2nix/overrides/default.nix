  ...
  lib.composeManyExtensions [
    ...
    (self: super:
      ...
      in {
        ...
        confluent-kafka = super.confluent-kafka.overridePythonAttrs (old: {
        ...
        eth-utils = super.eth-utils.overridePythonAttrs (old: {
          propagatedBuildInputs = builtins.filter (i: i.pname != "eth-hash")
        ...
        fiona = super.fiona.overridePythonAttrs (old: {
          format =
            lib.optionalString (!(old.src.isWheel or false)) "setuptools";
        ...
        jinja2-ansible-filters =
          super.jinja2-ansible-filters.overridePythonAttrs (old: {
            preBuild = (old.preBuild or "") + ''
        ...
        markupsafe = super.markupsafe.overridePythonAttrs (old: {
          src = old.src.override {
            pname = builtins.replaceStrings [ "markupsafe" ] [ "MarkupSafe" ]
              old.pname;
          };
        });
        ...
        mmdet = super.mmdet.overridePythonAttrs (old: {
        ...
        open3d = super.open3d.overridePythonAttrs (old: {
          ...
          buildInputs = (old.buildInputs or [ ]) ++ [ pkgs.libusb1 ]
            ++ lib.optionals stdenv.isLinux [ pkgs.udev ] ++ lib.optionals
        ...
        openbabel-wheel =
          super.openbabel-wheel.override { preferWheel = true; };
        ...
        pycairo = (drv:
          (drv.overridePythonAttrs
            (_: { format = "other"; })).overridePythonAttrs (old: {
