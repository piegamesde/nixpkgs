...
rustPlatform.buildRustPackage rec {
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "idt8a3xxxx-0.1.0" =
        "sha256-S36fS9hYTIn57Tt9msRiM7OFfujJEf8ED+9R9p0zgK4=";
      "libusb1-sys-0.5.0" =
        "sha256-7Bb1lpZvCb+OrKGYiD6NV+lMJuxFbukkRXsufaro5OQ=";
      ...
      "serialport-4.2.1-alpha.0" =
        "sha256-a2A2rKll2RTSyvohqRUSQ4Sw6puJdlTZoof5rePxPVE=";
      ...
      "vsc7448-info-0.1.0" =
        "sha256-otNLdfGIzuyu03wEb7tzhZVVMdS0of2sU/AKSNSsoho=";
    };
  };
