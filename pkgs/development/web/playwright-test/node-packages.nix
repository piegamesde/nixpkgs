  ...
  sources = {
    "@types/node-20.2.5" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "JJulVEQXmiY9Px5axXHeYGLSjhkZEnD+MDPDGbCbIAbMslkKwmygtZFy1X6s/075Yo94sf8GuSlFfPzysQrWZQ==";
      };
    };
    "fsevents-2.3.2" = {
      name = "fsevents";
    ...
    "playwright-core-1.34.3" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/playwright-core/-/playwright-core-1.34.3.tgz";
        sha512 =
          "2pWd6G7OHKemc5x1r1rp8aQcpvDh7goMBZlJv6Co5vCNLVcQJdhxRL09SGaY6HcyHH9aT4tiynZabMofVasBYw==";
      };
    };
  };
in {
  "@playwright/test-1.34.3" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 =
        "zPLef6w9P6T/iT6XDYG3mvGOqOyb6eHaV9XtkunYs0+OzxBtrPAAaHotc0X+PJ00WPPnLfFBTl7mf45Mn8DBmw==";
    };
    dependencies = [
