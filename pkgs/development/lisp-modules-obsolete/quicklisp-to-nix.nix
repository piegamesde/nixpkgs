...
let
  quicklisp-to-nix-packages = rec {
    ...
    "html-encode" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."html-encode" or (x: { })) (import ./quicklisp-to-nix-output/html-encode.nix { inherit fetchurl; }));
    ...
    "clack-socket" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."clack-socket" or (x: { })) (import ./quicklisp-to-nix-output/clack-socket.nix { inherit fetchurl; }));
    ...
    "glsl-symbols" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."glsl-symbols" or (x: { })) (import ./quicklisp-to-nix-output/glsl-symbols.nix { inherit fetchurl; }));

    "glsl-spec" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."glsl-spec" or (x: { })) (import ./quicklisp-to-nix-output/glsl-spec.nix { inherit fetchurl; }));
    ...
    "dissect" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."dissect" or (x: { })) (import ./quicklisp-to-nix-output/dissect.nix { inherit fetchurl; }));

    "lisp-unit" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."lisp-unit" or (x: { })) (import ./quicklisp-to-nix-output/lisp-unit.nix { inherit fetchurl; }));
    ...
    "trivial-macroexpand-all" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."trivial-macroexpand-all" or (x: { })) (import ./quicklisp-to-nix-output/trivial-macroexpand-all.nix { inherit fetchurl; })
    );
    ...
    "parseq" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."parseq" or (x: { })) (import ./quicklisp-to-nix-output/parseq.nix { inherit fetchurl; }));
    ...
    "lambda-fiddle" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."lambda-fiddle" or (x: { })) (import ./quicklisp-to-nix-output/lambda-fiddle.nix { inherit fetchurl; }));
    ...
    "hu_dot_dwim_dot_stefil_plus_hu_dot_dwim_dot_def_plus_swank" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."hu_dot_dwim_dot_stefil_plus_hu_dot_dwim_dot_def_plus_swank" or (x: { })) (
    ...
    "trivial-cltl2" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."trivial-cltl2" or (x: { })) (import ./quicklisp-to-nix-output/trivial-cltl2.nix { inherit fetchurl; }));
    ...
    "parse-declarations-1_dot_0" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."parse-declarations-1_dot_0" or (x: { })) (import ./quicklisp-to-nix-output/parse-declarations-1_dot_0.nix { inherit fetchurl; })
    );

    "introspect-environment" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."introspect-environment" or (x: { })) (import ./quicklisp-to-nix-output/introspect-environment.nix { inherit fetchurl; })
    );
    ...
    "net_dot_didierverna_dot_asdf-flv" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."net_dot_didierverna_dot_asdf-flv" or (x: { })) (import ./quicklisp-to-nix-output/net_dot_didierverna_dot_asdf-flv.nix { inherit fetchurl; })
    );
    ...
    "lack-component" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."lack-component" or (x: { })) (import ./quicklisp-to-nix-output/lack-component.nix { inherit fetchurl; }));

    "cl-aa" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-aa" or (x: { })) (import ./quicklisp-to-nix-output/cl-aa.nix { inherit fetchurl; }));

    "global-vars" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."global-vars" or (x: { })) (import ./quicklisp-to-nix-output/global-vars.nix { inherit fetchurl; }));

    "cl-anonfun" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-anonfun" or (x: { })) (import ./quicklisp-to-nix-output/cl-anonfun.nix { inherit fetchurl; }));
    ...
    "clunit" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."clunit" or (x: { })) (import ./quicklisp-to-nix-output/clunit.nix { inherit fetchurl; }));
    ...
    "s-xml" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."s-xml" or (x: { })) (import ./quicklisp-to-nix-output/s-xml.nix { inherit fetchurl; }));
    ...
    "zpb-ttf" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."zpb-ttf" or (x: { })) (import ./quicklisp-to-nix-output/zpb-ttf.nix { inherit fetchurl; }));

    "cl-paths" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-paths" or (x: { })) (import ./quicklisp-to-nix-output/cl-paths.nix { inherit fetchurl; }));
    ...
    "cl-l10n-cldr" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-l10n-cldr" or (x: { })) (import ./quicklisp-to-nix-output/cl-l10n-cldr.nix { inherit fetchurl; }));

    "string-case" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."string-case" or (x: { })) (import ./quicklisp-to-nix-output/string-case.nix { inherit fetchurl; }));

    "cl-difflib" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-difflib" or (x: { })) (import ./quicklisp-to-nix-output/cl-difflib.nix { inherit fetchurl; }));
    ...
    "unit-test" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."unit-test" or (x: { })) (import ./quicklisp-to-nix-output/unit-test.nix { inherit fetchurl; }));
    ...
    "ptester" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."ptester" or (x: { })) (import ./quicklisp-to-nix-output/ptester.nix { inherit fetchurl; }));
    ...
    "jpl-util" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."jpl-util" or (x: { })) (import ./quicklisp-to-nix-output/jpl-util.nix { inherit fetchurl; }));
    ...
    "clunit2" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."clunit2" or (x: { })) (import ./quicklisp-to-nix-output/clunit2.nix { inherit fetchurl; }));
    ...
    "xsubseq" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."xsubseq" or (x: { })) (import ./quicklisp-to-nix-output/xsubseq.nix { inherit fetchurl; }));
    ...
    "unix-opts" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."unix-opts" or (x: { })) (import ./quicklisp-to-nix-output/unix-opts.nix { inherit fetchurl; }));

    "unix-options" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."unix-options" or (x: { })) (import ./quicklisp-to-nix-output/unix-options.nix { inherit fetchurl; }));
    ...
    "trivial-types" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."trivial-types" or (x: { })) (import ./quicklisp-to-nix-output/trivial-types.nix { inherit fetchurl; }));

    "trivial-shell" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."trivial-shell" or (x: { })) (import ./quicklisp-to-nix-output/trivial-shell.nix { inherit fetchurl; }));

    "trivial-package-local-nicknames" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."trivial-package-local-nicknames" or (x: { })) (import ./quicklisp-to-nix-output/trivial-package-local-nicknames.nix { inherit fetchurl; })
    );

    "trivial-mimes" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."trivial-mimes" or (x: { })) (import ./quicklisp-to-nix-output/trivial-mimes.nix { inherit fetchurl; }));
    ...
    "trivial-indent" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."trivial-indent" or (x: { })) (import ./quicklisp-to-nix-output/trivial-indent.nix { inherit fetchurl; }));

    "trivial-gray-streams" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."trivial-gray-streams" or (x: { })) (import ./quicklisp-to-nix-output/trivial-gray-streams.nix { inherit fetchurl; })
    );
    ...
    "trees" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."trees" or (x: { })) (import ./quicklisp-to-nix-output/trees.nix { inherit fetchurl; }));
    ...
    "swank" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."swank" or (x: { })) (import ./quicklisp-to-nix-output/swank.nix { inherit fetchurl; }));
    ...
    "slynk" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."slynk" or (x: { })) (import ./quicklisp-to-nix-output/slynk.nix { inherit fetchurl; }));
    ...
    "rfc2388" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."rfc2388" or (x: { })) (import ./quicklisp-to-nix-output/rfc2388.nix { inherit fetchurl; }));
    ...
    "prove-asdf" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."prove-asdf" or (x: { })) (import ./quicklisp-to-nix-output/prove-asdf.nix { inherit fetchurl; }));
    ...
    "parse-number" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."parse-number" or (x: { })) (import ./quicklisp-to-nix-output/parse-number.nix { inherit fetchurl; }));
    ...
    "mt19937" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."mt19937" or (x: { })) (import ./quicklisp-to-nix-output/mt19937.nix { inherit fetchurl; }));
    ...
    "minheap" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."minheap" or (x: { })) (import ./quicklisp-to-nix-output/minheap.nix { inherit fetchurl; }));
    ...
    "metabang-bind" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."metabang-bind" or (x: { })) (import ./quicklisp-to-nix-output/metabang-bind.nix { inherit fetchurl; }));

    "md5" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."md5" or (x: { })) (import ./quicklisp-to-nix-output/md5.nix { inherit fetchurl; }));

    "marshal" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."marshal" or (x: { })) (import ./quicklisp-to-nix-output/marshal.nix { inherit fetchurl; }));
    ...
    "jsown" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."jsown" or (x: { })) (import ./quicklisp-to-nix-output/jsown.nix { inherit fetchurl; }));
    ...
    "iterate" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."iterate" or (x: { })) (import ./quicklisp-to-nix-output/iterate.nix { inherit fetchurl; }));
    ...
    "fare-csv" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."fare-csv" or (x: { })) (import ./quicklisp-to-nix-output/fare-csv.nix { inherit fetchurl; }));
    ...
    "css-lite" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."css-lite" or (x: { })) (import ./quicklisp-to-nix-output/css-lite.nix { inherit fetchurl; }));
    ...
    "closer-mop" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."closer-mop" or (x: { })) (import ./quicklisp-to-nix-output/closer-mop.nix { inherit fetchurl; }));
    ...
    "cl-utilities" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-utilities" or (x: { })) (import ./quicklisp-to-nix-output/cl-utilities.nix { inherit fetchurl; }));

    "cl-unification" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-unification" or (x: { })) (import ./quicklisp-to-nix-output/cl-unification.nix { inherit fetchurl; }));
    ...
    "cl-svg" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-svg" or (x: { })) (import ./quicklisp-to-nix-output/cl-svg.nix { inherit fetchurl; }));
    ...
    "cl-markup" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-markup" or (x: { })) (import ./quicklisp-to-nix-output/cl-markup.nix { inherit fetchurl; }));
    ...
    "cl-jpeg" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-jpeg" or (x: { })) (import ./quicklisp-to-nix-output/cl-jpeg.nix { inherit fetchurl; }));
    ...
    "cl-html-parse" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-html-parse" or (x: { })) (import ./quicklisp-to-nix-output/cl-html-parse.nix { inherit fetchurl; }));
    ...
    "cl-heap" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-heap" or (x: { })) (import ./quicklisp-to-nix-output/cl-heap.nix { inherit fetchurl; }));
    ...
    "cl-digraph" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-digraph" or (x: { })) (import ./quicklisp-to-nix-output/cl-digraph.nix { inherit fetchurl; }));
    ...
    "cl-custom-hash-table" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."cl-custom-hash-table" or (x: { })) (import ./quicklisp-to-nix-output/cl-custom-hash-table.nix { inherit fetchurl; })
    );
    ...
    "cl-css" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."cl-css" or (x: { })) (import ./quicklisp-to-nix-output/cl-css.nix { inherit fetchurl; }));
    ...
    "chipz" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."chipz" or (x: { })) (import ./quicklisp-to-nix-output/chipz.nix { inherit fetchurl; }));
    ...
    "binomial-heap" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."binomial-heap" or (x: { })) (import ./quicklisp-to-nix-output/binomial-heap.nix { inherit fetchurl; }));
    ...
    "asdf-system-connections" = buildLispPackage (
      (f: x: (x // (f x))) (qlOverrides."asdf-system-connections" or (x: { })) (import ./quicklisp-to-nix-output/asdf-system-connections.nix { inherit fetchurl; })
    );

    "array-utils" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."array-utils" or (x: { })) (import ./quicklisp-to-nix-output/array-utils.nix { inherit fetchurl; }));
    ...
    "alexandria" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."alexandria" or (x: { })) (import ./quicklisp-to-nix-output/alexandria.nix { inherit fetchurl; }));

    "acclimation" = buildLispPackage ((f: x: (x // (f x))) (qlOverrides."acclimation" or (x: { })) (import ./quicklisp-to-nix-output/acclimation.nix { inherit fetchurl; }));
