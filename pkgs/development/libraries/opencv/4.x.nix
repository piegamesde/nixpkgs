{ lib, stdenv, fetchurl, fetchFromGitHub, fetchpatch, cmake, pkg-config, unzip
, zlib, pcre, hdf5, boost, gflags, protobuf, config, ocl-icd, buildPackages
, qimgv, opencv4
  ...
  patches = [ ./cmake-don-t-use-OpenCVFindOpenEXR.patch ]
    ++ lib.optionals enableContrib [
      (fetchpatch {
        ...
        url =
          "https://github.com/opencv/opencv_contrib/commit/ccc277247ac1a7aef0a90353edcdec35fbc5903c.patch";
        stripLen = 2;
      ...
      (fetchpatch {
        ...
        url =
          "https://github.com/opencv/opencv_contrib/commit/ec406fa4748fb4b0630c1b986469e7918d5e8953.patch";
        stripLen = 2;
        extraPrefix = [ "opencv_contrib/" ];
