{ stdenv, lib, fetchurl, fetchpatch, gettext, meson, ninja, pkg-config, asciidoc
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://gitlab.gnome.org/GNOME/tracker/-/commit/4cbbd1773a7367492fa3b3e3804839654e18a12a.patch";
