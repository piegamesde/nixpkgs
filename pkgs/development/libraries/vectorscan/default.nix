{ lib, stdenv, fetchFromGitHub, cmake, ragel, util-linux, python3, boost
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ cmake ragel util-linux python3 ];
  ...
  meta = with lib; {
    ...
    changelog =
      "https://github.com/VectorCamp/vectorscan/blob/${src.rev}/CHANGELOG.md";
