...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "mirror://sourceforge/presage/presage/${version}/presage-${version}.tar.gz";
  ...
  patches = [
    (fetchpatch {
      name = "gcc6.patch";
      url =
        "https://git.alpinelinux.org/aports/plain/community/presage/gcc6.patch?id=40e2044c9ecb36eacb3a1fd043f09548d210dc01";
    ...
    (fetchpatch {
      ...
      url =
        "https://build.opensuse.org/public/source/openSUSE:Factory/presage/presage-0.9.1-gcc11.patch?rev=3f8b4b19c99276296d6ea595cc6c431f";
