...
, libplacebo, librsvg, libssh, libtensorflow, libtheora, libv4l, libva
, libva-minimal, libvdpau, libvmaf, libvorbis, libvpx, libwebp, libX11, libxcb
, libXv, libXext, libxml2, xz, nv-codec-headers, nv-codec-headers-11, openal
, ocl-icd # OpenCL ICD
