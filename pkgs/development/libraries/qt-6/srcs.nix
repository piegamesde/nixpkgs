...

{
  qt3d = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qt3d-everywhere-src-6.5.0.tar.xz";
  ...
  qt5compat = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qt5compat-everywhere-src-6.5.0.tar.xz";
  ...
  qtactiveqt = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtactiveqt-everywhere-src-6.5.0.tar.xz";
  ...
  qtbase = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtbase-everywhere-src-6.5.0.tar.xz";
  ...
  qtcharts = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtcharts-everywhere-src-6.5.0.tar.xz";
  ...
  qtconnectivity = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtconnectivity-everywhere-src-6.5.0.tar.xz";
  ...
  qtdatavis3d = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtdatavis3d-everywhere-src-6.5.0.tar.xz";
  ...
  qtdeclarative = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtdeclarative-everywhere-src-6.5.0.tar.xz";
  ...
  qtdoc = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtdoc-everywhere-src-6.5.0.tar.xz";
  ...
  qtgrpc = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtgrpc-everywhere-src-6.5.0.tar.xz";
  ...
  qthttpserver = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qthttpserver-everywhere-src-6.5.0.tar.xz";
  ...
  qtimageformats = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtimageformats-everywhere-src-6.5.0.tar.xz";
  ...
  qtlanguageserver = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtlanguageserver-everywhere-src-6.5.0.tar.xz";
  ...
  qtlocation = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtlocation-everywhere-src-6.5.0.tar.xz";
  ...
  qtlottie = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtlottie-everywhere-src-6.5.0.tar.xz";
  ...
  qtmultimedia = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtmultimedia-everywhere-src-6.5.0.tar.xz";
  ...
  qtnetworkauth = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtnetworkauth-everywhere-src-6.5.0.tar.xz";
  ...
  qtpositioning = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtpositioning-everywhere-src-6.5.0.tar.xz";
  ...
  qtquick3d = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtquick3d-everywhere-src-6.5.0.tar.xz";
  ...
  qtquick3dphysics = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtquick3dphysics-everywhere-src-6.5.0.tar.xz";
  ...
  qtquickeffectmaker = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtquickeffectmaker-everywhere-src-6.5.0.tar.xz";
  ...
  qtquicktimeline = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtquicktimeline-everywhere-src-6.5.0.tar.xz";
  ...
  qtremoteobjects = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtremoteobjects-everywhere-src-6.5.0.tar.xz";
  ...
  qtscxml = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtscxml-everywhere-src-6.5.0.tar.xz";
  ...
  qtsensors = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtsensors-everywhere-src-6.5.0.tar.xz";
  ...
  qtserialbus = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtserialbus-everywhere-src-6.5.0.tar.xz";
  ...
  qtserialport = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtserialport-everywhere-src-6.5.0.tar.xz";
  ...
  qtshadertools = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtshadertools-everywhere-src-6.5.0.tar.xz";
  ...
  qtspeech = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtspeech-everywhere-src-6.5.0.tar.xz";
  ...
  qtsvg = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtsvg-everywhere-src-6.5.0.tar.xz";
  ...
  qttools = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qttools-everywhere-src-6.5.0.tar.xz";
  ...
  qttranslations = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qttranslations-everywhere-src-6.5.0.tar.xz";
  ...
  qtvirtualkeyboard = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtvirtualkeyboard-everywhere-src-6.5.0.tar.xz";
  ...
  qtwayland = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtwayland-everywhere-src-6.5.0.tar.xz";
  ...
  qtwebchannel = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtwebchannel-everywhere-src-6.5.0.tar.xz";
  ...
  qtwebengine = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtwebengine-everywhere-src-6.5.0.tar.xz";
  ...
  qtwebsockets = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtwebsockets-everywhere-src-6.5.0.tar.xz";
  ...
  qtwebview = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.0/submodules/qtwebview-everywhere-src-6.5.0.tar.xz";
