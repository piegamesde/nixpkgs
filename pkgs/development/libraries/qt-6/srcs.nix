...

{
  qt3d = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qt3d-everywhere-src-6.5.1.tar.xz";
  ...
  qt5compat = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qt5compat-everywhere-src-6.5.1.tar.xz";
  ...
  qtactiveqt = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtactiveqt-everywhere-src-6.5.1.tar.xz";
  ...
  qtbase = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtbase-everywhere-src-6.5.1.tar.xz";
  ...
  qtcharts = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtcharts-everywhere-src-6.5.1.tar.xz";
  ...
  qtconnectivity = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtconnectivity-everywhere-src-6.5.1.tar.xz";
  ...
  qtdatavis3d = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtdatavis3d-everywhere-src-6.5.1.tar.xz";
  ...
  qtdeclarative = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtdeclarative-everywhere-src-6.5.1.tar.xz";
  ...
  qtdoc = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtdoc-everywhere-src-6.5.1.tar.xz";
  ...
  qtgrpc = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtgrpc-everywhere-src-6.5.1.tar.xz";
  ...
  qthttpserver = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qthttpserver-everywhere-src-6.5.1.tar.xz";
  ...
  qtimageformats = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtimageformats-everywhere-src-6.5.1.tar.xz";
  ...
  qtlanguageserver = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtlanguageserver-everywhere-src-6.5.1.tar.xz";
  ...
  qtlocation = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtlocation-everywhere-src-6.5.1.tar.xz";
  ...
  qtlottie = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtlottie-everywhere-src-6.5.1.tar.xz";
  ...
  qtmultimedia = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtmultimedia-everywhere-src-6.5.1.tar.xz";
  ...
  qtnetworkauth = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtnetworkauth-everywhere-src-6.5.1.tar.xz";
  ...
  qtpositioning = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtpositioning-everywhere-src-6.5.1.tar.xz";
  ...
  qtquick3d = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtquick3d-everywhere-src-6.5.1.tar.xz";
  ...
  qtquick3dphysics = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtquick3dphysics-everywhere-src-6.5.1.tar.xz";
  ...
  qtquickeffectmaker = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtquickeffectmaker-everywhere-src-6.5.1.tar.xz";
  ...
  qtquicktimeline = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtquicktimeline-everywhere-src-6.5.1.tar.xz";
  ...
  qtremoteobjects = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtremoteobjects-everywhere-src-6.5.1.tar.xz";
  ...
  qtscxml = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtscxml-everywhere-src-6.5.1.tar.xz";
  ...
  qtsensors = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtsensors-everywhere-src-6.5.1.tar.xz";
  ...
  qtserialbus = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtserialbus-everywhere-src-6.5.1.tar.xz";
  ...
  qtserialport = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtserialport-everywhere-src-6.5.1.tar.xz";
  ...
  qtshadertools = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtshadertools-everywhere-src-6.5.1.tar.xz";
  ...
  qtspeech = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtspeech-everywhere-src-6.5.1.tar.xz";
  ...
  qtsvg = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtsvg-everywhere-src-6.5.1.tar.xz";
  ...
  qttools = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qttools-everywhere-src-6.5.1.tar.xz";
  ...
  qttranslations = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qttranslations-everywhere-src-6.5.1.tar.xz";
  ...
  qtvirtualkeyboard = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtvirtualkeyboard-everywhere-src-6.5.1.tar.xz";
  ...
  qtwayland = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtwayland-everywhere-src-6.5.1.tar.xz";
  ...
  qtwebchannel = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtwebchannel-everywhere-src-6.5.1.tar.xz";
  ...
  qtwebengine = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtwebengine-everywhere-src-6.5.1.tar.xz";
  ...
  qtwebsockets = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtwebsockets-everywhere-src-6.5.1.tar.xz";
  ...
  qtwebview = {
    ...
    src = fetchurl {
      url =
        "${mirror}/official_releases/qt/6.5/6.5.1/submodules/qtwebview-everywhere-src-6.5.1.tar.xz";
