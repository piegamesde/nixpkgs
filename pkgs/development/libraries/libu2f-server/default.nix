...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://developers.yubico.com/libu2f-server/Releases/${pname}-${version}.tar.xz";
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/Yubico/libu2f-server/commit/f7c4983b31909299c47bf9b2627c84b6bfe225de.patch";
