{ mkDerivation, lib, stdenv, fetchpatch, extra-cmake-modules, docbook_xml_dtd_45
, docbook_xsl_ns, karchive, ki18n, qtbase, perl, perlPackages }:
  ...
  # kf.doctools.core: Error: Could not find kdoctools catalogs
    ++ lib.optionals stdenv.isDarwin [
      (fetchpatch {
        ...
        url =
          "https://github.com/msys2/MINGW-packages/raw/0900785a1f4e4146ab9561fb92a1c70fa70fcfc4/mingw-w64-kdoctools-qt5/0001-kdoctools-relocate-datapath.patch";
