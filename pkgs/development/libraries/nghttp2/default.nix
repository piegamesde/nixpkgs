...
, libev, openssl, zlib, enableAsioLib ? false, boost, enableGetAssets ? false
, libxml2, enableHpack ? false, jansson, enableJemalloc ? false, jemalloc
...
stdenv.mkDerivation rec {
  ...
  configureFlags = [ "--disable-examples" (lib.enableFeature enableApp "app") ]
