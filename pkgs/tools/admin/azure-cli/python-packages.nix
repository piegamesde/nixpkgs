...
let
  ...
  py = python3.override {
    packageOverrides = self: super: {
      ...
      azure-mgmt-rdbms =
        overrideAzureMgmtPackage super.azure-mgmt-rdbms "10.2.0b10" "zip"
      ...
      azure-mgmt-keyvault =
        overrideAzureMgmtPackage super.azure-mgmt-keyvault "10.2.3" "zip"
      ...
      azure-keyvault-keys =
        overrideAzureMgmtPackage super.azure-keyvault-keys "4.8.0b2" "zip"
