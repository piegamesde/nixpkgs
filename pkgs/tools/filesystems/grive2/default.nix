{ lib, stdenv, fetchFromGitHub, fetchpatch, pkg-config, yajl, cmake, libgcrypt
, curl, expat, boost, libiberty }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      name = "gcc-12.patch";
      url =
        "https://github.com/vitalif/grive2/commit/3cf1c058a3e61deb370dde36024a106a213ab2c6.patch";
