...
let
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@babel/core-7.21.8" // { dependencies = [ sources."semver-6.3.0" ]; })
      (
      ...
      (
        sources."@babel/helper-compilation-targets-7.21.5" // { dependencies = [ sources."semver-6.3.0" ]; }
      )
      (
      ...
      (sources."@babel/preset-env-7.21.5" // { dependencies = [ sources."semver-6.3.0" ]; })
      ...
      (sources."@mui/base-5.0.0-beta.1" // { dependencies = [ sources."react-is-18.2.0" ]; })
      sources."@mui/core-downloads-tracker-5.13.1"
      sources."@mui/icons-material-5.11.16"
      (sources."@mui/material-5.13.1" // { dependencies = [ sources."react-is-18.2.0" ]; })
      sources."@mui/private-theming-5.13.1"
      sources."@mui/styled-engine-5.12.3"
      sources."@mui/system-5.13.1"
      sources."@mui/types-7.2.4"
      (sources."@mui/utils-5.13.1" // { dependencies = [ sources."react-is-18.2.0" ]; })
      (
      ...
      (sources."@swc/helpers-0.5.1" // { dependencies = [ sources."tslib-2.5.2" ]; })
      ...
      (sources."camel-case-4.1.2" // { dependencies = [ sources."tslib-2.5.2" ]; })
      sources."camelcase-6.3.0"
      sources."camelcase-css-2.0.1"
      (sources."camelcase-keys-6.2.2" // { dependencies = [ sources."camelcase-5.3.1" ]; })
      ...
      (sources."clean-css-5.3.2" // { dependencies = [ sources."source-map-0.6.1" ]; })
      ...
      (sources."css-2.2.4" // { dependencies = [ sources."source-map-0.6.1" ]; })
      ...
      (sources."dot-case-3.0.4" // { dependencies = [ sources."tslib-2.5.2" ]; })
      ...
      (sources."es-get-iterator-1.1.3" // { dependencies = [ sources."isarray-2.0.5" ]; })
      ...
      (sources."fibers-5.0.3" // { dependencies = [ sources."detect-libc-1.0.3" ]; })
      ...
      (sources."http-errors-1.8.1" // { dependencies = [ sources."depd-1.1.2" ]; })
      ...
      (
        ...
        // {
          dependencies = [
            ...
            sources."has-flag-4.0.0"
            (sources."jest-message-util-28.1.3" // { dependencies = [ sources."slash-3.0.0" ]; })
      ...
      (sources."koa-static-5.0.0" // { dependencies = [ sources."debug-3.2.7" ]; })
      ...
      (sources."lower-case-2.0.2" // { dependencies = [ sources."tslib-2.5.2" ]; })
      ...
      sources."memfs-3.5.1"
      (sources."meow-9.0.0" // { dependencies = [ sources."type-fest-0.18.1" ]; })
      ...
      (sources."minimist-options-4.1.0" // { dependencies = [ sources."is-plain-obj-1.1.0" ]; })
      ...
      sources."p-map-4.0.0"
      (sources."p-retry-4.6.2" // { dependencies = [ sources."retry-0.13.1" ]; })
      sources."p-try-2.2.0"
      (sources."param-case-3.0.4" // { dependencies = [ sources."tslib-2.5.2" ]; })
      sources."parent-module-1.0.1"
      sources."parse-json-5.2.0"
      sources."parse5-6.0.1"
      sources."parseurl-1.3.3"
      (sources."pascal-case-3.1.2" // { dependencies = [ sources."tslib-2.5.2" ]; })
      ...
      (sources."postcss-load-config-4.0.1" // { dependencies = [ sources."yaml-2.2.2" ]; })
      ...
      (sources."rework-1.0.1" // { dependencies = [ sources."convert-source-map-0.3.5" ]; })
      ...
      (sources."safe-array-concat-1.0.0" // { dependencies = [ sources."isarray-2.0.5" ]; })
      ...
      (sources."sockjs-client-1.6.1" // { dependencies = [ sources."debug-3.2.7" ]; })
      sources."socks-2.7.1"
      ...
      (sources."terser-5.17.4" // { dependencies = [ sources."commander-2.20.3" ]; })
      ...
      (sources."ts-node-10.9.1" // { dependencies = [ sources."acorn-walk-8.2.0" ]; })
      (sources."tsconfig-paths-3.14.2" // { dependencies = [ sources."json5-1.0.2" ]; })
      ...
      (sources."whatwg-encoding-1.0.5" // { dependencies = [ sources."iconv-lite-0.4.24" ]; })
