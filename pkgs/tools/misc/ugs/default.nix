{ stdenv, lib, copyDesktopItems, makeDesktopItem, makeWrapper, jre, fetchzip
, bash }:
let
...
in stdenv.mkDerivation rec {
  ...
  src = fetchzip {
    url =
      "https://github.com/winder/Universal-G-Code-Sender/releases/download/v${version}/UniversalGcodeSender.zip";
