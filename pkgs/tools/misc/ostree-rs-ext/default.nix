{ lib, rustPlatform, fetchFromGitHub, pkg-config, makeWrapper, glib, openssl
, zlib, ostree, stdenv, darwin, util-linux, skopeo, gnutar, ima-evm-utils }:
...
rustPlatform.buildRustPackage rec {
  ...
  buildInputs = [ glib openssl zlib ostree ] ++ lib.optionals stdenv.isDarwin [
