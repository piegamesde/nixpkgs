{ stdenv, lib, fetchzip, fetchpatch, bzip2, lzo, openssl_1_1
, opensslSupport ? false, zlib }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/fix-compile.patch?h=quickbms&id=a2e3e4638295d7cfe39513bfef9447fb23154a6b";
