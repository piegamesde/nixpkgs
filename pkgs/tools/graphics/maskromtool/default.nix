{ lib, stdenv, fetchFromGitHub, cmake, qtbase, qt6, wrapQtAppsHook }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ qtbase qt6.qtcharts qt6.qttools ];
  ...
  meta = {
    ...
    license = [ lib.licenses.beerware lib.licenses.gpl1Plus ];
