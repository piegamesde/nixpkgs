{ lib, stdenv, fetchurl, fetchpatch, pkg-config, gnutls, libgcrypt, libpar2
, libsigcxx, libxml2, ncurses, openssl, zlib, nixosTests }:
...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/nzbget/nzbget/commit/f76e8555504e3af4cf8dd4a8c8e374b3ca025099.patch";
  ...
  buildInputs =
    [ gnutls libgcrypt libpar2 libsigcxx libxml2 ncurses openssl zlib ];
