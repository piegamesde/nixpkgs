...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://members.home.nl/p.a.rombouts/pdnsd/releases/pdnsd-${version}.tar.gz";
  ...
  patches =
    ...
    lib.optional stdenv.isLinux (fetchpatch {
      ...
      url =
        "https://gitweb.gentoo.org/repo/gentoo.git/plain/net-dns/pdnsd/files/pdnsd-1.2.9a-linux-5.13_build_fix.patch?id=7ce35657f269c3b7016e8940ad36e59cf06e12a4";
