...
rustPlatform.buildRustPackage rec {
  ...
  cargoLock = {
    ...
    outputHashes = {
      "assert_cmd-1.0.1" =
        "sha256-0MkQG+JKrZXOn8B8q1HdyhZ1hVVb7dPbGEo/76o2YRc=";
      "edgedb-derive-0.4.0" =
        "sha256-pE/GchC3JDg0E4twmov86byne+rn28JpIawBbZcJHOg=";
      "edgeql-parser-0.1.0" =
        "sha256-e43PBHirALfrxGKi50KvE9aDAunObpXcWNBs62ssgSM=";
