  ...
  sources = {
    ...
    "@eslint/js-8.42.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "6SWlXpWU5AvId8Ac7zjzmIOqMOba/JWY8XZ4A7q7Gn1Vlfg/SFFIlrtHXt9nPn4op9ZPAkl91Jao+QQv3r/ukw==";
      };
    };
    ...
    "auto-launch-5.0.6" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "OgxiAm4q9EBf9EeXdPBiVNENaWE3jUZofwrhAkWjHDYGezu1k3FRZHU8V2FBxGuSJOHzKmTJEd0G7L7/0xDGFA==";
      };
    };
    "aws-sign2-0.7.0" = {
      name = "aws-sign2";
    ...
    "capture-stack-trace-1.0.2" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/capture-stack-trace/-/capture-stack-trace-1.0.2.tgz";
        sha512 =
          "X/WM2UQs6VMHUtjUDnZTRI+i1crWteJySFzr9UpGoQa4WQffXVTTXuekjl7TjZRlcF2XfjgITT0HxZ9RnxeT0w==";
      };
    };
    "caseless-0.12.0" = {
      name = "caseless";
    ...
    "chai-as-promised-7.1.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "azL6xMoi+uxu6z4rhWQ1jbdUhOMhis2PvscD/xjLqNMkv3BPPp2JyyuTHOrf9BOosGpNQ11v6BKv/g57RXbiaA==";
      };
    };
    "chainsaw-0.1.0" = {
      name = "chainsaw";
    ...
    "create-error-class-3.0.2" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "gYTKKexFO3kh200H1Nit76sRwRtOY32vQd3jpAQKpLtZqyNsSQNfI4N7o3eP2wUjV35pTWKRYqFUDBvUha/Pkw==";
      };
    };
    "cross-spawn-7.0.3" = {
      name = "cross-spawn";
    ...
    "decompress-zip-0.3.3" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/decompress-zip/-/decompress-zip-0.3.3.tgz";
        sha512 =
          "/fy1L4s+4jujqj3kNptWjilFw3E6De8U6XUFvqmh4npN3Vsypm3oT2V0bXcmbBWS+5j5tr4okYaFrOmyZkszEg==";
      };
    };
    "deep-eql-4.1.3" = {
      name = "deep-eql";
    ...
    "download-5.0.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "rE0V29BV5FyylK3Uw5hmP90TBuwGHAqPYfaRHW/VHsKe9Xqi7RACVg0k0FokeE+MTWr9mtUy75GyszRACiD3Ow==";
      };
    };
    "duplexer3-0.1.5" = {
      name = "duplexer3";
    ...
    "eslint-8.42.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "ulg9Ms6E1WPf67PHaEY4/6E2tEn5/f7FXGzr3t9cBMugOmf1INYvuUwwh1aXQN4MfJ6a5K2iNwP3w4AColvI9A==";
      };
    };
    "eslint-scope-7.2.0" = {
      name = "eslint-scope";
    ...
    "file-exists-2.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "xiDzGS+oe7RleGLItoPTKVj3DjKHiVANV6dEyWTt3yB08H/AHuyvjh0aZ8jISQ53yhyTWVLsDzhJ5IbvPciBjg==";
      };
    };
    "file-type-3.9.0" = {
      name = "file-type";
    ...
    "filename-reserved-regex-2.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "lc1bnsSr4L4Bdif8Xb/qrtokGbq5zlsms/CYH8PP+WtCkGNF65DPiQY8vG3SakEdRn8Dlnm+gW/qWKKjS5sZzQ==";
      };
    };
    "filenamify-2.1.0" = {
      name = "filenamify";
    ...
    "fs-jetpack-5.1.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Xn4fDhLydXkuzepZVsr02jakLlmoARPy+YWIclo4kh0GyNGUHnTqeH/w/qIsVn50dFxtp8otPL2t/HcPJBbxUA==";
      };
    };
    ...
    "got-6.7.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "Y/K3EDuiQN9rTZhBvPRWMLXIKdeD1Rj0nzunfoi0Yyn5WBEbzxXKU9Ub2X41oZBagVWOBU3MuDonFMgPWQFnwg==";
      };
    };
    "graceful-fs-4.2.11" = {
      name = "graceful-fs";
    ...
    "is-redirect-1.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "cr/SlUEe5zOGmzvj9bUyC4LVvkNVAXu4GytXLNMr1pny+a65MpQ9IJzFHD5vi7FyJgb4qt27+eS3TuQnqB+RQw==";
      };
    };
    "is-relative-1.0.0" = {
      name = "is-relative";
    ...
    "json-11.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "N/ITv3Yw9Za8cGxuQqSqrq6RHnlaHWZkAFavcfpH/R52522c26EbihMxnY7A1chxfXJ4d+cEFIsyTgfi9GihrA==";
      };
    };
    "json-schema-0.4.0" = {
      name = "json-schema";
    ...
    "mkpath-0.1.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "bauHShmaxVQiEvlrAPWxSPn8spSL8gDVRl11r8vLT4r/KdnknLqtqwQbToZ2Oa8sJkExYY1z6/d+X7pNiqo4yg==";
      };
    };
    "mocha-10.2.0" = {
      name = "mocha";
    ...
    "nw-0.71.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "EQVv20UEY8JHC36iKyJPb9q19mmeKcezT5MnaIUjRhsgMcnZztXz9+Uaj2nOTLB3ZGq4EF/7rYSiZ0wU+Prspg==";
      };
    };
    "nw-autoupdater-1.1.11" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/nw-autoupdater/-/nw-autoupdater-1.1.11.tgz";
        sha512 =
          "kCDRDCRayjZSwE8VhIclUyDjkylzHz9JT2WK/45wFNcW/9y6zaR/fy+AG2V266YF4XWFEId9ZuK2M3nIBpm9iw==";
      };
    };
    "nw-dev-3.0.1" = {
      name = "nw-dev";
      ...
      src = fetchurl {
        ...
        sha512 =
          "wlabaoKfO+2ZngERU5L6e7eXf0Hi41eAD01IBvjYh7wrIUdQKe1/wfVaeSMuZ0UYeu9zmOFu2uA2wOLTdY6+pg==";
      };
    };
    "oauth-sign-0.9.0" = {
      name = "oauth-sign";
    ...
    "selenium-webdriver-4.9.2" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/selenium-webdriver/-/selenium-webdriver-4.9.2.tgz";
        sha512 =
          "0gDswAgVn6qbCYckZetQQvQK9tWW1r7LaumhiqY1/Wl/7JEWG0JANsTbZKnmGc3+cUU76zAi5/p0P8LUweXlig==";
      };
    };
    "semver-5.7.1" = {
      name = "semver";
    ...
    "touch-0.0.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "/LQ54KM9rPf3rGXGo2UPQWx3ol242Zg6Whq27H5DEmZhCJo+pm9N5BzRGepO9vTVhYxpXJdcc1+3uaYt9NyeKg==";
      };
    };
    "tough-cookie-2.5.0" = {
      name = "tough-cookie";
    ...
    "trim-repeated-1.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "pkonvlKk8/ZuR0D5tLW8ljt5I8kmxp2XKymhepUeOdCEfKpZaktSArkLHZt76OB1ZvO9bssUsDty4SWhLvZpLg==";
      };
    };
    "tunnel-agent-0.6.0" = {
      name = "tunnel-agent";
    ...
    "unzip-response-2.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "N0XH6lqDtFH84JxptQoZYmloF4nzrQqqrAymNj+/gW60AO2AZgOcf4O/nUXJcYfyQkqvMo9lSupBZmmgvuVXlw==";
      };
    };
    "upath-1.2.0" = {
      name = "upath";
  ...
  "onlykey-git+https://github.com/trustcrypto/OnlyKey-App.git#v5.5.0" =
    nodeEnv.buildNodePackage {
      ...
      src = fetchgit {
        ...
        sha256 =
          "f0c49dafe8210813de1a9eb7622d53fa0c84c17384516defaa2f42ac29a8cebc";
      };
      dependencies = [
        ...
        (sources."nw-0.71.1" // { dependencies = [ sources."yargs-3.32.0" ]; })
        ...
        (sources."read-pkg-up-1.0.1" // {
          dependencies =
            [ sources."find-up-1.1.2" sources."path-exists-2.1.0" ];
        })
        ...
        (sources."touch-0.0.3" // { dependencies = [ sources."nopt-1.0.10" ]; })
