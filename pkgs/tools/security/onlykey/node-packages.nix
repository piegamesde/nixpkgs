    ...
    nodeEnv.buildNodePackage
      {
        ...
        dependencies = [
          ...
          (sources."download-5.0.3" // { dependencies = [ sources."get-stream-3.0.0" ]; })
          ...
          (sources."npm-conf-1.1.3" // { dependencies = [ sources."pify-3.0.0" ]; })
          ...
          (sources."object.omit-2.0.1" // { dependencies = [ sources."for-own-0.1.5" ]; })
