{ lib, fetchpatch, fetchFromGitHub, buildGoModule }:
...
buildGoModule rec {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/genuinetools/reg/commit/f37b04ad8be47f1e68ef9b2c5906324d7096231e.patch";
      hash = "sha256-wmBjPdrpNpxx//I+d+k8DNR11TmyXxb84vXR/MrYHKA=";
    })
    (fetchpatch {
      name = "update-vendored-dependencies.patch";
      url =
        "https://github.com/genuinetools/reg/commit/8bb04bc3fd41c089716e65ee905c6feac8bda5a0.patch";
