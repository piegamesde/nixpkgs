{ lib, runCommand, mutter, elementary-default-settings, glib, gala, epiphany
, gnome-settings-daemon, gtk3, elementary-dock, gsettings-desktop-schemas
...
in runCommand "elementary-gsettings-desktop-schemas" {
