...
lib.trivial.pipe super [
  ...
  (patchExtension "dash-to-dock@micxgx.gmail.com" (
    old: { meta.maintainers = with lib.maintainers; [ rhoriguchi ]; }
  ))
  ...
  (patchExtension "display-brightness-ddcutil@themightydeity.github.com" (
    old: {
  ...
  (patchExtension "eepresetselector@ulville.github.io" (
    old: {
      patches =
        [
  ...
  (patchExtension "gnome-shell-screenshot@ttll.de" (
    old: {
      # Requires gjs
  ...
  (patchExtension "gtk4-ding@smedius.gitlab.com" (
    old: {
      patches = [
        (substituteAll {
  ...
  (patchExtension "x11gestures@joseexposito.github.io" (
    old: {
