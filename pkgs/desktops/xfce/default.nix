...
makeScopeWithSplicing (generateSplicesForMkScope "xfce") keep extra (
  ...
  in
  {
    ...
    automakeAddFlags = pkgs.makeSetupHook { name = "xfce-automake-add-flags-hook"; } ./automakeAddFlags.sh;
    ...
    xfce4-dev-tools = callPackage ./core/xfce4-dev-tools { mkXfceDerivation = self.mkXfceDerivation.override { xfce4-dev-tools = null; }; };
