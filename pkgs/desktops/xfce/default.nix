...
in
  makeScopeWithSplicing (generateSplicesForMkScope "xfce") keep extra (self:
    let
    ...
    in
      {
        ...
        xfce4-screenshooter =
          callPackage ./applications/xfce4-screenshooter { };

        xfdashboard = callPackage ./applications/xfdashboard { };

        xfce4-volumed-pulse =
          callPackage ./applications/xfce4-volumed-pulse { };
        ...
        xfce4-panel-profiles =
          callPackage ./applications/xfce4-panel-profiles { };
        ...
        xfce4-battery-plugin =
          callPackage ./panel-plugins/xfce4-battery-plugin { };

        xfce4-clipman-plugin =
          callPackage ./panel-plugins/xfce4-clipman-plugin { };

        xfce4-cpufreq-plugin =
          callPackage ./panel-plugins/xfce4-cpufreq-plugin { };
        ...
        xfce4-fsguard-plugin =
          callPackage ./panel-plugins/xfce4-fsguard-plugin { };

        xfce4-genmon-plugin =
          callPackage ./panel-plugins/xfce4-genmon-plugin { };

        xfce4-i3-workspaces-plugin =
          callPackage ./panel-plugins/xfce4-i3-workspaces-plugin { };

        xfce4-namebar-plugin =
          callPackage ./panel-plugins/xfce4-namebar-plugin { };

        xfce4-netload-plugin =
          callPackage ./panel-plugins/xfce4-netload-plugin { };
        ...
        xfce4-sensors-plugin =
          callPackage ./panel-plugins/xfce4-sensors-plugin { };
        ...
        xfce4-weather-plugin =
          callPackage ./panel-plugins/xfce4-weather-plugin { };
