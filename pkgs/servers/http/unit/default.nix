...
, withPerldevel ? false, perldevel, withRuby_3_0 ? false, ruby_3_0
, withRuby_3_1 ? true, ruby_3_1, withRuby_3_2 ? false, ruby_3_2, withSSL ? true
...
in stdenv.mkDerivation rec {
  ...
  buildInputs = [ pcre2.dev ] ++ optionals withPython3 [ python3 ncurses ]
    ++ optional withPHP81 php81-unit ++ optional withPHP82 php82-unit
    ++ optional withPerl534 perl534 ++ optional withPerl536 perl536
    ++ optional withPerldevel perldevel ++ optional withRuby_3_0 ruby_3_0
    ++ optional withRuby_3_1 ruby_3_1 ++ optional withRuby_3_2 ruby_3_2
