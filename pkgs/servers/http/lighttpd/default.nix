{ lib, stdenv, buildPackages, fetchurl, pkg-config, pcre2, libxml2, zlib, bzip2
, which, file, fetchpatch, openssl, enableDbi ? false, libdbi
, enableMagnet ? false, lua5_1, enableMysql ? false, libmysqlclient
, enableLdap ? false, openldap, enablePam ? false, linux-pam, enableSasl ? false
, cyrus_sasl, enableWebDAV ? false, sqlite, libuuid, enableExtendedAttrs ? false
, attr, perl, nixosTests }:
...
stdenv.mkDerivation rec {
  ...
  passthru.tests = { inherit (nixosTests) lighttpd; };
