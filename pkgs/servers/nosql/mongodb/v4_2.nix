{ stdenv, callPackage, fetchpatch, lib, sasl, boost, Security, CoreFoundation
, cctools }:
...
in buildMongoDB {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://raw.githubusercontent.com/gentoo/gentoo/7168257cad6ea7c4856b01c5703d0ed5b764367c/dev-db/mongodb/files/mongodb-4.4.1-gcc11.patch";
