...
let
  sources = {
    ...
    "stream-to-string-1.2.0" = {
      ...
      src = fetchurl {
        url =
          "https://registry.npmjs.org/stream-to-string/-/stream-to-string-1.2.0.tgz";
        sha512 =
          "8drZlFIKBHSMdX9GCWv8V9AAWnQcTqw0iAI6/GC7UJ0H0SwKeFKjOoZfGY1tOU00GGU7FYZQoJ/ZCUEoXhD7yQ==";
      };
    };
