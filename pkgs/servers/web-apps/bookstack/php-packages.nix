  ...
  packages = {
    ...
    "aws/aws-sdk-php" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/aws/aws-sdk-php/zipball/c600a07da531d6c29af791b9d2e8b6df796aa14b";
    ...
    "barryvdh/laravel-snappy" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "barryvdh-laravel-snappy-2c18a3602981bc6f25b32908cf8aaa05952ab2f7";
        src = fetchurl {
          url =
            "https://api.github.com/repos/barryvdh/laravel-snappy/zipball/2c18a3602981bc6f25b32908cf8aaa05952ab2f7";
    ...
    "dompdf/dompdf" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/dompdf/dompdf/zipball/c5310df0e22c758c85ea5288175fc6cd777bc085";
    ...
    "filp/whoops" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/filp/whoops/zipball/f7948baaa0330277c729714910336383286305da";
    ...
    "graham-campbell/result-type" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "graham-campbell-result-type-a878d45c1914464426dc94da61c9e1d36ae262a8";
        src = fetchurl {
          url =
    ...
    "knplabs/knp-snappy" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/KnpLabs/snappy/zipball/5126fb5b335ec929a226314d40cd8dad497c3d67";
    ...
    "laravel/framework" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/laravel/framework/zipball/e1afe088b4ca613fb96dc57e6d8dbcb8cc2c6b49";
    ...
    "laravel/serializable-closure" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "laravel-serializable-closure-47afb7fae28ed29057fdca37e16a84f90cc62fae";
        src = fetchurl {
          url =
            "https://api.github.com/repos/laravel/serializable-closure/zipball/47afb7fae28ed29057fdca37e16a84f90cc62fae";
    ...
    "laravel/socialite" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/laravel/socialite/zipball/dae03ca4ecfe3badafcdfb81965d2279080051f4";
    ...
    "league/commonmark" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/thephpleague/commonmark/zipball/2b8185c13bc9578367a5bf901881d1c1b5bbd09b";
    ...
    "league/html-to-markdown" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "league-html-to-markdown-e0fc8cf07bdabbcd3765341ecb50c34c271d64e1";
        src = fetchurl {
          url =
            "https://api.github.com/repos/thephpleague/html-to-markdown/zipball/e0fc8cf07bdabbcd3765341ecb50c34c271d64e1";
    ...
    "league/oauth2-client" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/thephpleague/oauth2-client/zipball/2334c249907190c132364f5dae0287ab8666aa19";
    ...
    "nesbot/carbon" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/briannesbitt/Carbon/zipball/09acf64155c16dc6f580f36569ae89344e9734a3";
    ...
    "onelogin/php-saml" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/onelogin/php-saml/zipball/b22a57ebd13e838b90df5d3346090bc37056409d";
    ...
    "phpseclib/phpseclib" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/phpseclib/phpseclib/zipball/f28693d38ba21bb0d9f0c411ee5dae2b178201da";
    ...
    "predis/predis" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/predis/predis/zipball/a2fb02d738bedadcffdbb07efa3a5e7bd57f8d6e";
    ...
    "psy/psysh" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/bobthecow/psysh/zipball/e9eadffbed9c9deb5426fd107faae0452bf20a36";
    ...
    "socialiteproviders/discord" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-discord-c6eddeb07ace7473e82d02d4db852dfacf5ef574";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/Discord/zipball/c6eddeb07ace7473e82d02d4db852dfacf5ef574";
    ...
    "socialiteproviders/gitlab" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-gitlab-a8f67d3b02c9ee8c70c25c6728417c0eddcbbb9d";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/GitLab/zipball/a8f67d3b02c9ee8c70c25c6728417c0eddcbbb9d";
    ...
    "socialiteproviders/manager" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-manager-738276dfbc2b68a9145db7b3df1588d53db528a1";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/Manager/zipball/738276dfbc2b68a9145db7b3df1588d53db528a1";
    ...
    "socialiteproviders/microsoft-azure" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-microsoft-azure-7522b27cd8518706b50e03b40a396fb0a6891feb";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/Microsoft-Azure/zipball/7522b27cd8518706b50e03b40a396fb0a6891feb";
    ...
    "socialiteproviders/okta" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-okta-7c0b7522423943131f680e74123b71ccd3989541";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/Okta/zipball/7c0b7522423943131f680e74123b71ccd3989541";
    ...
    "socialiteproviders/slack" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-slack-2b781c95daf06ec87a8f3deba2ab613d6bea5e8d";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/Slack/zipball/2b781c95daf06ec87a8f3deba2ab613d6bea5e8d";
    ...
    "socialiteproviders/twitch" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "socialiteproviders-twitch-7accf30ae7a3139b757b4ca8f34989c09a3dbee7";
        src = fetchurl {
          url =
            "https://api.github.com/repos/SocialiteProviders/Twitch/zipball/7accf30ae7a3139b757b4ca8f34989c09a3dbee7";
    ...
    "ssddanbrown/htmldiff" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/ssddanbrown/HtmlDiff/zipball/58f81857c02b50b199273edb4cc339876b5a4038";
    ...
    "symfony/console" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/console/zipball/58422fdcb0e715ed05b385f70d3e8b5ed4bbd45f";
    ...
    "symfony/css-selector" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/css-selector/zipball/052ef49b660f9ad2a3adb311c555c9bc11ba61f4";
    ...
    "symfony/error-handler" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/error-handler/zipball/b900446552833ad2f91ca7dd52aa8ffe78f66cb2";
    ...
    "symfony/event-dispatcher" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "symfony-event-dispatcher-8e18a9d559eb8ebc2220588f1faa726a2fcd31c9";
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/event-dispatcher/zipball/8e18a9d559eb8ebc2220588f1faa726a2fcd31c9";
    ...
    "symfony/finder" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/finder/zipball/40c08632019838dfb3350f18cf5563b8080055fc";
    ...
    "symfony/http-foundation" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "symfony-http-foundation-b64a0e2df212d5849e4584cabff0cf09c5d6866a";
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/http-foundation/zipball/b64a0e2df212d5849e4584cabff0cf09c5d6866a";
    ...
    "symfony/mime" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/mime/zipball/2a83d82efc91c3f03a23c8b47a896df168aa5c63";
    ...
    "symfony/polyfill-iconv" = {
      ...
      src = composerEnv.buildZipPackage {
        name =
          "symfony-polyfill-iconv-927013f3aac555983a5059aada98e1907d842695";
        src = fetchurl {
          url =
    ...
    "symfony/process" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/process/zipball/6e75fe6874cbc7e4773d049616ab450eff537bf1";
    ...
    "symfony/routing" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/routing/zipball/4ce2df9a469c19ba45ca6aca04fec1c358a6e791";
    ...
    "symfony/string" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/string/zipball/55733a8664b8853b003e70251c58bc8cb2d82a6b";
    ...
    "symfony/translation" = {
      ...
      src = composerEnv.buildZipPackage {
        ...
        src = fetchurl {
          url =
            "https://api.github.com/repos/symfony/translation/zipball/f0ed07675863aa6e3939df8b1bc879450b585cab";
