{ lib, stdenv, fetchurl, fetchpatch, pcre, pcre2, jemalloc, libunwind, libxslt
, groff, ncurses, pkg-config, readline, libedit, coreutils, python3, makeWrapper
, nixosTests }:
...
let
  common = { version, hash, extraNativeBuildInputs ? [ ] }:
    stdenv.mkDerivation rec {
      ...
      buildInputs = [ libxslt groff ncurses readline libedit python3 ]
