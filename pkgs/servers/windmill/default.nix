{ lib, rustPlatform, fetchFromGitHub, buildNpmPackage, bash, cairo, deno
, fetchurl, go, lld, makeWrapper, nsjail, openssl, pango, pixman, pkg-config
, python3, rust, rustfmt, stdenv, swagger-cli }:
...
in rustPlatform.buildRustPackage {
  ...
  RUSTY_V8_ARCHIVE = let
    ...
    fetch_librusty_v8 = args:
      fetchurl {
        ...
        sha256 = args.shas.${stdenv.hostPlatform.system} or (throw
          "Unsupported platform ${stdenv.hostPlatform.system}");
        meta = { inherit (args) version; };
      };
  in fetch_librusty_v8 {
    version = "0.71.0";
    shas = {
  ...
  cargoLock = {
    ...
    outputHashes = {
      "progenitor-0.3.0" =
        "sha256-EPiAeAKCYBHiISGdXyuqlX/+Xp1feQmniLzt/FIDiLw=";
