...
self: super:
{
  ...
  libXtst = super.libXtst.overrideAttrs (
    attrs: {
      meta = attrs.meta // {
  ...
  libpthreadstubs = super.libpthreadstubs.overrideAttrs (
    attrs: {
  ...
  xcbutilerrors = super.xcbutilerrors.overrideAttrs (
    attrs: {
      outputs = [
        "out"
        "dev"
  ...
  xorgdocs = super.xorgdocs.overrideAttrs (
    attrs: {
