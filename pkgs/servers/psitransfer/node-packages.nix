...
in
{
  "psitransfer-git+https://github.com/psi-4ward/psitransfer#v2.1.2" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (sources."archiver-utils-2.1.0" // { dependencies = [ sources."readable-stream-2.3.8" ]; })
      ...
      (sources."finalhandler-1.2.0" // { dependencies = [ sources."debug-2.6.9" ]; })
      ...
      (sources."lazystream-1.0.1" // { dependencies = [ sources."readable-stream-2.3.8" ]; })
