{ lib, stdenv, fetchFromGitHub, fetchpatch, meson, ninja, pkg-config, glib
, systemd, boost, fmt, buildPackages
# Darwin inputs
    ...
    in stdenv.mkDerivation rec {
      ...
      patches = [
        (fetchpatch {
          ...
          url =
            "https://github.com/MusicPlayerDaemon/MPD/commit/838af929a0ae07e238d30cd7afc96cd7311457ef.patch";
