...
in
  rustPlatform.buildRustPackage rec {
    ...
    cargoLock = {
      ...
      outputHashes = {
        "criterion-0.3.5" =
          "sha256-gXhwLw99kC08zxHdY6l5LF5EVzAAFasI4GLnopLwhEU=";
        ...
        "postgres-0.19.1" =
          "sha256-zH7PF4p7wJCSYpuydTL3HPcOjPU9SlTy6IJREOe2l7U=";
        ...
        "rdkafka-0.28.0" =
          "sha256-u2gBTzu+IvXTDvcZGzPaVpSVOgAKhTth7GLwob4urDs=";
