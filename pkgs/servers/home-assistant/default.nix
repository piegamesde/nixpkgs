...
let
  defaultOverrides = [
    ...
    (self: super: {
      ...
      aiowatttime = super.aiowatttime.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.1.1";
          src = fetchFromGitHub {
            owner = "bachya";
      ...
      astral = super.astral.overridePythonAttrs (
        oldAttrs: rec {
          pname = "astral";
          version = "2.2";
          src = fetchPypi {
      ...
      ha-av = super.av.overridePythonAttrs (
        oldAttrs: rec {
          pname = "ha-av";
          version = "10.1.1";
      ...
      intellifire4py = super.intellifire4py.overridePythonAttrs (
        oldAttrs: rec {
          version = "2.2.2";
          src = fetchFromGitHub {
            owner = "jeeftor";
      ...
      jaraco-abode = super.jaraco-abode.overridePythonAttrs (
        oldAttrs: rec {
          version = "3.3.0";
          src = fetchFromGitHub {
            inherit (oldAttrs.src) owner repo;
      ...
      justnimbus = super.justnimbus.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.6.0";
          src = fetchFromGitHub {
            owner = "kvanzuijlen";
      ...
      poolsense = super.poolsense.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.0.8";
          src = fetchPypi {
            pname = "poolsense";
      ...
      p1monitor = super.p1monitor.overridePythonAttrs (
        oldAttrs: rec {
          version = "2.1.1";
          src = fetchFromGitHub {
            inherit (oldAttrs.src) owner repo;
      ...
      pyasn1 = super.pyasn1.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.4.8";
          src = fetchPypi {
      ...
      pyatag = super.pyatag.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.3.5.3";
          src = fetchFromGitHub {
            owner = "MatsNl";
      ...
      pydexcom = super.pydexcom.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.2.3";
          src = fetchFromGitHub {
            owner = "gagebenne";
      ...
      pykaleidescape = super.pykaleidescape.overridePythonAttrs (
        oldAttrs: rec {
          version = "1.0.1";
          src = fetchFromGitHub {
            inherit (oldAttrs.src) owner repo;
      ...
      pysnooz = super.pysnooz.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.8.6";
          src = fetchFromGitHub {
      ...
      python-slugify = super.python-slugify.overridePythonAttrs (
        oldAttrs: rec {
      ...
      python-tado = super.python-tado.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.15.0";
          src = fetchFromGitHub {
            owner = "wmalgadey";
      ...
      pytradfri = super.pytradfri.overridePythonAttrs (
        oldAttrs: rec {
          version = "9.0.1";
          src = fetchFromGitHub {
      ...
      vultr = super.vultr.overridePythonAttrs (
        oldAttrs: rec {
          version = "0.1.2";
          src = fetchFromGitHub {
            owner = "spry-group";
      ...
      websockets = super.websockets.overridePythonAttrs (
        oldAttrs: rec {
          version = "11.0.1";
          src = fetchFromGitHub {
            owner = "aaugustin";
