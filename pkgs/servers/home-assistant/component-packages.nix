...

{
  ...
  components = {
    ...
    "renson" = ps: with ps; [ ]; # missing inputs: renson-endura-delta
    "reolink" =
      ps:
      with ps; [
        aiohttp-cors
    ...
    "switchbot_cloud" = ps: with ps; [ ]; # missing inputs: switchbot-api
    ...
    "wolflink" = ps: with ps; [ ]; # missing inputs: wolf-smartset
