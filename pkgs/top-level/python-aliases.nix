...
in
  mapAliases ({
    ...
    buildbot-worker =
      throw "use pkgs.buildbot-worker instead"; # added 2022-04-07
    buildbot-pkg = throw
    ...
    dftfit = throw
      "dftfit dependency lammps-cython no longer builds"; # added 2021-07-04
    ...
    faulthandler = throw
      "faulthandler is built into ${python.executable}"; # added 2021-07-12
    filemagic = throw
      "inactive since 2014, so use python-magic instead"; # added 2022-11-19
    ...
    privacyidea = throw
      "privacyidea has been renamed to pkgs.privacyidea"; # added 2021-06-20
    ...
    uproot3-methods =
      throw "uproot3-methods has been removed"; # added 2022-12-13
