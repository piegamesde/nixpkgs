...

{
  ...
  interpreters = {
    ...
    erlang_25_javac = self.interpreters.erlang_25.override {
      javacSupport = true;
    };
    ...
    erlang_24_javac = self.interpreters.erlang_24.override {
      javacSupport = true;
    };
    ...
    erlang_23_javac = self.interpreters.erlang_23.override {
      javacSupport = true;
    };
