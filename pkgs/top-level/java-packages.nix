...
in
{
  ...
  inherit
    (callPackage ../development/java-modules/apache/ant-launcher.nix {
      inherit fetchMaven;
    })
    antLauncher_1_8_2
  ;
  ...
  inherit
    (callPackage ../development/java-modules/beanshell/bsh.nix {
      inherit fetchMaven;
    })
    bsh_2_0_b4
  ;
  ...
  inherit
    (callPackage ../development/java-modules/apache/commons-cli.nix {
      inherit fetchMaven;
    })
    commonsCli_1_0
    commonsCli_1_2
  ...
  inherit
    (callPackage ../development/java-modules/apache/commons-io.nix {
      inherit fetchMaven;
    })
    commonsIo_2_1
  ;
  ...
  inherit
    (callPackage ../development/java-modules/apache/commons-lang.nix {
      inherit fetchMaven;
    })
    commonsLang_2_1
    commonsLang_2_3
  ...
  inherit
    (callPackage ../development/java-modules/apache/commons-lang3.nix {
      inherit fetchMaven;
    })
    commonsLang3_3_1
  ;
  ...
  inherit
    (callPackage ../development/java-modules/apache/commons-logging-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/findbugs/jsr305.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/google/collections.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/hamcrest/all.nix {
      inherit fetchMaven;
    })
    hamcrestAll_1_3
  ;
  ...
  inherit
    (callPackage ../development/java-modules/hamcrest/core.nix {
      inherit fetchMaven;
    })
    hamcrestCore_1_3
  ;
  ...
  inherit
    (callPackage ../development/java-modules/junit {
  ...
  inherit
    (callPackage ../development/java-modules/maven/archiver.nix {
      inherit fetchMaven;
    })
    mavenArchiver_2_5
  ;
  ...
  inherit
    (callPackage ../development/java-modules/maven/artifact.nix {
      inherit fetchMaven;
    })
    mavenArtifact_2_0_1
    mavenArtifact_2_0_6
  ...
  inherit
    (callPackage ../development/java-modules/maven/common-artifact-filters.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/doxia-sink-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/enforcer.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/filtering.nix {
      inherit fetchMaven;
    })
    mavenFiltering_1_1
  ;
  ...
  inherit
    (callPackage ../development/java-modules/maven/model.nix {
      inherit fetchMaven;
    })
    mavenModel_2_0_1
    mavenModel_2_0_6
  ...
  inherit
    (callPackage ../development/java-modules/maven/monitor.nix {
      inherit fetchMaven;
    })
    mavenMonitor_2_0_1
    mavenMonitor_2_0_6
  ...
  inherit
    (callPackage ../development/java-modules/maven/plugin-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/plugin-testing-harness.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/profile.nix {
      inherit fetchMaven;
    })
    mavenProfile_2_0_1
    mavenProfile_2_0_6
  ...
  inherit
    (callPackage ../development/java-modules/maven/project.nix {
      inherit fetchMaven;
    })
    mavenProject_2_0_1
    mavenProject_2_0_6
  ...
  inherit
    (callPackage ../development/java-modules/maven/reporting-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/settings.nix {
      inherit fetchMaven;
    })
    mavenSettings_2_0_1
    mavenSettings_2_0_6
  ...
  inherit
    (callPackage ../development/java-modules/maven/shared-utils.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/surefire-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/maven/toolchain.nix {
      inherit fetchMaven;
    })
    mavenToolchain_1_0
  ...
  inherit
    (callPackage ../development/java-modules/mojo/animal-sniffer.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/ow2/asm-all.nix {
      inherit fetchMaven;
    })
    ow2AsmAll_4_0
  ;
  ...
  inherit
    (callPackage ../development/java-modules/plexus/archiver.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/build-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/classworlds.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/compiler-api.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/component-annotations.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/digest.nix {
      inherit fetchMaven;
    })
    plexusDigest_1_0
  ;
  ...
  inherit
    (callPackage ../development/java-modules/plexus/i18n.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/interpolation.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/plexus/utils.nix {
      inherit fetchMaven;
    })
    plexusUtils_1_0_4
    plexusUtils_1_0_5
  ...
  inherit
    (callPackage ../development/java-modules/sisu/inject-bean.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/sisu/inject-plexus.nix {
      inherit fetchMaven;
    })
  ...
  inherit
    (callPackage ../development/java-modules/apache/xbean-reflect.nix {
      inherit fetchMaven;
    })
    xbeanReflect_3_4
  ;
  ...
  inherit
    (callPackage ../development/java-modules/xerces/impl.nix {
      inherit fetchMaven;
    })
    xercesImpl_2_8_0
  ;
  ...
  inherit
    (callPackage ../development/java-modules/xml-apis { inherit fetchMaven; })
    xmlApis_1_3_03
  ;
}
