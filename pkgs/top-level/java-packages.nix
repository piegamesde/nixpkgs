...
in
{
  ...
  inherit
    (callPackage ../development/java-modules/apache/commons-logging-api.nix { inherit fetchMaven; })
  ...
  inherit (callPackage ../development/java-modules/jogl { }) jogl_2_3_2 jogl_2_4_0;
