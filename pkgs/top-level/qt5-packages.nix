      ...
      (
        noExtraAttrs (
          ...
          // {
            ...
            applet-window-appmenu =
              callPackage ../development/libraries/applet-window-appmenu
                { };
            ...
            mlt = pkgs.mlt.override { enableQt = true; };
            ...
            qtkeychain = callPackage ../development/libraries/qtkeychain {
              stdenv =
                if pkgs.stdenv.isDarwin then pkgs.darwin.apple_sdk_11_0.stdenv else pkgs.stdenv;
        ...
        // lib.optionalAttrs pkgs.config.allowAliases {
          ...
          overrideScope' =
            lib.warn
              ''
                libsForQt5 now uses makeScopeWithSplicing which does not have "overrideScope'", use "overrideScope".''
              self.overrideScope;
        }
      )
    );
