  ...
  mkOcamlPackages =
    ...
    (lib.makeScope newScope (
      ...
      with self; {
        ...
        dns-client =
          callPackage ../development/ocaml-modules/dns/client.nix
            { }
          ;
        ...
        irmin-pack =
          callPackage ../development/ocaml-modules/irmin/pack.nix
            { }
          ;

        irmin-test =
          callPackage ../development/ocaml-modules/irmin/test.nix
            { }
          ;
