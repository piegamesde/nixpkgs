...
stdenv.mkDerivation rec {
  ...
  patches = lib.lists.map fetchpatch [
    ...
    {
      url =
        "https://github.com/EasyCrypt/easycrypt/commit/d226387432deb7f22738e1d5579346a2cbc9be7a.patch";
      hash = "sha256:1zvxij35fnr3h9b5wdl8ml17aqfx3a39rd4mgwmdvkapbg3pa4lm";
    }
    # Fix build with Why3 1.6
    {
      url =
        "https://github.com/EasyCrypt/easycrypt/commit/876f2ed50a0434afdf2fb20e7c50b8a3e26bb06e.patch";
