...
in
  ...
  let
    ...
    test_model_weights = fetchurl {
      ...
      sha256 =
        "472d4a06035497b180636d8a82667129960371375bd10fcb6df5c6c7631f25e0";
    };
  ...
  in
    stdenv.mkDerivation rec {
      ...
      buildInputs = [
        ...
        ++ lib.optional cudnnSupport cudnn ++ lib.optional lmdbSupport lmdb
        ++ lib.optional ncclSupport nccl ++ lib.optionals leveldbSupport [
          leveldb
          snappy
      ...
      patches = [ ./darwin.patch ] ++ lib.optional pythonSupport
        (substituteAll {
          src = ./python.patch;
