{ lib, fetchpatch, fetchFromGitHub, buildNpmPackage, installShellFiles
, makeWrapper, bash, nodejs, gzip, python3 }:
...
buildNpmPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/midchildan/EPGStation/commit/5d6cad746b7d9b6d246adcdecf9c991b77c9d89e.patch";
      sha256 = "sha256-9a8VUjczlyQHVO7w9MYorPIZunAuBuif1HNmtp1yMk8=";
    })
    (fetchpatch {
      url =
        "https://github.com/midchildan/EPGStation/commit/c948e833e485c2b7cb7fb33b953cca1e20de3a70.patch";
  ...
  in ''
    ...
    sed 's/@DESCRIPTION@/${meta.description}/g' ${
      ./epgstation.1
    } > doc/epgstation.1
