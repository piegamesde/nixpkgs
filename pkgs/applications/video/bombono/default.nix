...
, dvdplusrwtools, enca, cdrkit, ffmpeg_4, gettext, gtk2, gtkmm2, libdvdread
...
let
  fetchPatchFromAur = { name, sha256 }:
    fetchpatch {
      inherit name sha256;
      url =
        "https://aur.archlinux.org/cgit/aur.git/plain/${name}?h=766dd4ba1715fc921fe26ce1bdcf22c30f4fc073";
    };
in stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    {
      name = "inc_boost_header.patch";
      sha256 = "sha256-76vjkf62VsNJ5FmBEs+X7ZBqjvJ372mjSIreBxNQym8=";
    }
  ]);
