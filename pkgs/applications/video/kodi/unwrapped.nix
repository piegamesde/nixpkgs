...
, pkg-config, cmake, yasm, python3Packages, libxcrypt, libgcrypt, libgpg-error
...
, flac, libxslt, lzo, libcdio, libmodplug, libass, libbluray, libudfread, sqlite
...
, doxygen, giflib, glib, harfbuzz, lcms2, libidn2, libpthreadstubs, libtasn1
...
assert usbSupport
  -> !udevSupport; # libusb-compat-0_1 won't be used if udev is available
