{ lib, stdenv, fetchurl, fetchpatch, wrapGAppsHook4, cargo, desktop-file-utils
, meson, ninja, pkg-config, rustc, gdk-pixbuf, glib, gtk4, gtksourceview5
, libadwaita, darwin }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "https://gitlab.gnome.org/World/design/icon-library/uploads/5dd3d97acfdbaf69c7dc6b2f7bbf4cae/icon-library-${version}.tar.xz";
