...
let
  dropDocOutput = { outputs, ... }: { outputs = lib.filter (x: x != "doc") outputs; };
  ...
  python3' = python310.override {
    packageOverrides = self: super: {
      ...
      pyopenssl =
        (super.pyopenssl.override {
          sphinxHook = null;
          sphinx-rtd-theme = null;
        }).overridePythonAttrs
          dropDocOutput;
      deprecated = (super.deprecated.override { sphinxHook = null; }).overridePythonAttrs dropDocOutput;
      wrapt =
        (super.wrapt.override {
          sphinxHook = null;
          sphinx-rtd-theme = null;
        }).overridePythonAttrs
          dropDocOutput;
