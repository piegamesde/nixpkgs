{ lib, fetchFromGitHub, cacert, openssl, nixosTests, python310, fetchPypi
, fetchpatch }:
  ...
  python3' = python310.override {
    packageOverrides = self: super: {
      ...
      pyjwt = (super.pyjwt.override {
        ...
        (old: (dropDocOutput old) // { format = "setuptools"; });
      ...
      deprecated =
        (super.deprecated.override { sphinxHook = null; }).overridePythonAttrs
        dropDocOutput;
...
in python3'.pkgs.buildPythonPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/privacyidea/privacyidea/commit/7db6509721726a34e8528437ddbd4210019b11ef.patch";
