{ lib, stdenv, cmake, ninja, intltool, fetchurl, libxml2, webkitgtk_4_1
, highlight, pkg-config, gtk3, glib, libnotify, libpst, gspell
, evolution-data-server, libgweather, glib-networking, gsettings-desktop-schemas
, wrapGAppsHook, itstool, shared-mime-info, libical, db, sqlite, gnome
, gnome-desktop, librsvg, gdk-pixbuf, libsecret, nss, nspr, icu
, libcanberra-gtk3, geocode-glib_2, cmark, bogofilter, gst_all_1, procps
, p11-kit, openldap, spamassassin }:
