...
in
{
  n8n = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      (
        sources."@azure/msal-browser-2.37.0" // { dependencies = [ sources."@azure/msal-common-13.0.0" ]; }
      )
      sources."@azure/msal-common-7.6.0"
      (sources."@azure/msal-node-1.17.2" // { dependencies = [ sources."@azure/msal-common-13.0.0" ]; })
      (
      ...
      (
        ...
        // {
          dependencies = [ sources."@fortawesome/fontawesome-common-types-6.4.0" ];
        }
      )
      (
      ...
      (
        ...
        // {
          dependencies = [
            ...
            (sources."teeny-request-8.0.3" // { dependencies = [ sources."uuid-9.0.0" ]; })
      ...
      (sources."@redis/client-1.5.7" // { dependencies = [ sources."yallist-4.0.0" ]; })
      ...
      (sources."@sentry-internal/tracing-7.52.1" // { dependencies = [ sources."tslib-1.14.1" ]; })
      (sources."@sentry/core-7.52.1" // { dependencies = [ sources."tslib-1.14.1" ]; })
      (sources."@sentry/integrations-7.52.1" // { dependencies = [ sources."tslib-1.14.1" ]; })
      (sources."@sentry/node-7.52.1" // { dependencies = [ sources."tslib-1.14.1" ]; })
      sources."@sentry/types-7.52.1"
      (sources."@sentry/utils-7.52.1" // { dependencies = [ sources."tslib-1.14.1" ]; })
      ...
      (sources."@types/node-fetch-2.6.4" // { dependencies = [ sources."form-data-3.0.1" ]; })
      ...
      (sources."auto-changelog-1.16.4" // { dependencies = [ sources."semver-6.3.0" ]; })
      sources."available-typed-arrays-1.0.5"
      sources."avsc-5.7.7"
      (sources."aws-crt-1.15.16" // { dependencies = [ sources."axios-0.24.0" ]; })
      (
      ...
      (sources."bull-4.10.4" // { dependencies = [ sources."cron-parser-4.8.1" ]; })
      ...
      (sources."formstream-1.2.0" // { dependencies = [ sources."mime-2.6.0" ]; })
      ...
      (sources."glob-10.2.6" // { dependencies = [ sources."minimatch-9.0.1" ]; })
      ...
      (sources."html-to-text-9.0.4" // { dependencies = [ sources."deepmerge-4.3.1" ]; })
      (sources."htmlparser2-8.0.2" // { dependencies = [ sources."entities-4.5.0" ]; })
      ...
      (sources."jsonpath-1.1.1" // { dependencies = [ sources."esprima-1.2.2" ]; })
      ...
      (sources."mssql-9.1.1" // { dependencies = [ sources."commander-9.5.0" ]; })
      ...
      (
        ...
        // {
          dependencies = [
            ...
            (sources."through2-2.0.5" // { dependencies = [ sources."readable-stream-2.3.8" ]; })
            sources."ws-7.5.9"
          ];
        }
      )
      (sources."n8n-workflow-0.148.0" // { dependencies = [ sources."ast-types-0.15.2" ]; })
      ...
      (sources."pdf-parse-1.1.1" // { dependencies = [ sources."debug-3.2.7" ]; })
      ...
      (sources."promise-ftp-1.3.5" // { dependencies = [ sources."bluebird-2.11.0" ]; })
      ...
      (sources."sanitize-html-2.10.0" // { dependencies = [ sources."deepmerge-4.3.1" ]; })
      sources."sax-1.2.4"
      ...
      (sources."stream-browserify-3.0.0" // { dependencies = [ sources."readable-stream-3.6.2" ]; })
      ...
      (sources."through2-filter-3.0.0" // { dependencies = [ sources."through2-2.0.5" ]; })
      ...
      (sources."winston-3.8.2" // { dependencies = [ sources."readable-stream-3.6.2" ]; })
      ...
      (sources."xss-1.0.14" // { dependencies = [ sources."commander-2.20.3" ]; })
      sources."xtend-4.0.2"
      sources."y18n-5.0.8"
