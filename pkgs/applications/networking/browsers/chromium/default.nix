{ newScope, config, stdenv, fetchurl, makeWrapper, llvmPackages_16, ed, gnugrep
, coreutils, xdg-utils, glib, gtk3, gtk4, gnome, gsettings-desktop-schemas, gn
, fetchgit, libva, pipewire, wayland, gcc, nspr, nss, runCommand, lib, libkrb5
