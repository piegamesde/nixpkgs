...
let
  ...
  mozLocale = if systemLocale == "ca_ES@valencia" then "ca-valencia" else lib.replaceStrings [ "_" ] [ "-" ] systemLocale;
...
stdenv.mkDerivation {
  ...
  passthru.updateScript = import ./update.nix {
    inherit
      ...
      runtimeShell
    ;
    baseUrl = if channel == "devedition" then "https://archive.mozilla.org/pub/devedition/releases/" else "https://archive.mozilla.org/pub/firefox/releases/";
  };
  meta = with lib; {
