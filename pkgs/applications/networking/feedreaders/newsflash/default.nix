{ lib, stdenv, rustPlatform, fetchFromGitLab, cargo, meson, ninja, pkg-config
, rustc, wrapGAppsHook4, gdk-pixbuf, glib, gtk4, libadwaita, libxml2, openssl
, sqlite, webkitgtk, glib-networking, librsvg, gst_all_1, gitUpdater }:
  ...
  cargoDeps = rustPlatform.importCargoLock {
    ...
    outputHashes = {
      "javascriptcore6-0.1.0" =
        "sha256-7w8CDY13dCRlFc77XxJ2/xZqlKSjqM0eiOvILOrJ4ic=";
      "news-flash-2.3.0-alpha.0" =
        "sha256-phoZmTY1YVZIIktqLMnal9H5SMgNWwx7m+7AMtDcFJM=";
      "newsblur_api-0.2.0" =
        "sha256-6vnFeJbdFeIau2rpUk9o72DD2ZCqicljmQjFVhY71NI=";
      "article_scraper-2.0.0-alpha.0" =
        "sha256-HPEKZc7O7pbgcwR2l0kD/5442W1hzrfMadc0amrjxwI=";
    };
  };
