{ lib, stdenv, fetchurl, fetchpatch, ocamlPackages, gnome2, pkg-config
, makeWrapper, glib, libtool, libpng, bison, expat, fontconfig, gd, pango
, libjpeg, libwebp, libX11, libXaw }:
...
in let inherit (gnome2) libgnomecanvas;
in let inherit (ocamlPackages) ocaml lablgtk camlp4;
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url =
      "http://oandrieu.nerim.net/monotone-viz/${pname}-${version}-nolablgtk.tar.gz";
  ...
  patches = [
    (fetchpatch {
      url =
        "https://src.fedoraproject.org/rpms/monotone-viz/raw/c9f4c1bebe01bb471df05d8a37ca4b6d630574ec/f/monotone-viz-1.0.2-dot.patch";
      hash = "sha256-e348703+IzM4m/3cpe6Z9VebZgTK8+3lRLdaTfXHwSI=";
    })
    (fetchpatch {
      url =
        "https://src.fedoraproject.org/rpms/monotone-viz/raw/c9f4c1bebe01bb471df05d8a37ca4b6d630574ec/f/monotone-viz-1.0.2-new-stdio.patch";
      hash = "sha256-9xQzJ+oYz06fDFOe1YOOisEZnwiwShqr2Rt7IXiu6Zo=";
    })
    (fetchpatch {
      url =
        "https://src.fedoraproject.org/rpms/monotone-viz/raw/c9f4c1bebe01bb471df05d8a37ca4b6d630574ec/f/monotone-viz-1.0.2-typefix.patch";
