...
rustPlatform.buildRustPackage rec {
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "eth-secp256k1-0.5.7" =
        "sha256-2ZwY2cODE7AVJ2WBTuHZ01dZXegeNmZHKRUXVemLs1A=";
      "eth_pairings-0.6.0" =
        "sha256-2qLyuOArJOH029JKXuyB67p9gggsTRpavW1AO4O93L4=";
  ...
  checkFlags =
    [ "--skip" "configuration::tests::should_resolve_external_nat_hosts" ];
