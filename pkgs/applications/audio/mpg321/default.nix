...
stdenv.mkDerivation rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://raw.githubusercontent.com/Homebrew/formula-patches/85fa66a9/mpg321/0.3.2.patch";
  ...
  configureFlags = [ ("--enable-alsa=" + (if stdenv.isLinux then
    "yes"
  else
    "no")) ] ++ (lib.optional (defaultAudio != null)
