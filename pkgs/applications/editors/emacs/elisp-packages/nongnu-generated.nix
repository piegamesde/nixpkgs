{ callPackage }: {
  ...
  auto-dim-other-buffers = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
  ...
  cider = callPackage ({ clojure-mode, elpaBuild, emacs, fetchurl, lib, parseedn
    ...
    elpaBuild {
      ...
      packageRequires =
        [ clojure-mode emacs parseedn queue seq sesman spinner ];
      meta = {
  ...
  color-theme-tangotango = callPackage
    ({ color-theme, elpaBuild, fetchurl, lib }:
      elpaBuild {
  ...
  corfu-terminal = callPackage
    ({ corfu, elpaBuild, emacs, fetchurl, lib, popon }:
      elpaBuild {
  ...
  cycle-at-point = callPackage ({ elpaBuild, emacs, fetchurl, lib, recomplete }:
    elpaBuild {
  ...
  evil-exchange = callPackage
    ({ cl-lib ? null, elpaBuild, evil, fetchurl, lib }:
      elpaBuild {
        pname = "evil-exchange";
        ename = "evil-exchange";
        version = "0.41";
  ...
  evil-lisp-state = callPackage
    ({ bind-map, elpaBuild, evil, fetchurl, lib, smartparens }:
      elpaBuild {
  ...
  flymake-popon = callPackage
    ({ elpaBuild, emacs, fetchurl, flymake ? null, lib, popon, posframe }:
      elpaBuild {
        pname = "flymake-popon";
        ename = "flymake-popon";
        version = "0.5.1";
  ...
  geiser-guile = callPackage
    ({ elpaBuild, emacs, fetchurl, geiser, lib, transient }:
      elpaBuild {
        pname = "geiser-guile";
        ename = "geiser-guile";
        version = "0.28.1";
  ...
  git-commit = callPackage
    ({ dash, elpaBuild, emacs, fetchurl, lib, transient, with-editor }:
      elpaBuild {
        pname = "git-commit";
        ename = "git-commit";
        version = "3.3.0";
  ...
  highlight-parentheses = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
  ...
  idris-mode = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, prop-menu }:
      elpaBuild {
        pname = "idris-mode";
        ename = "idris-mode";
        version = "1.1.0";
  ...
  inf-clojure = callPackage ({ clojure-mode, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "inf-clojure";
      ename = "inf-clojure";
      version = "3.2.1";
  ...
  magit = callPackage ({ dash, elpaBuild, emacs, fetchurl, git-commit, lib
    , magit-section, transient, with-editor }:
    elpaBuild {
      pname = "magit";
      ename = "magit";
      version = "3.3.0";
      ...
      packageRequires =
        [ dash emacs git-commit magit-section transient with-editor ];
      meta = {
  ...
  mentor = callPackage
    ({ async, elpaBuild, emacs, fetchurl, lib, seq, url-scgi, xml-rpc }:
      elpaBuild {
        pname = "mentor";
        ename = "mentor";
        version = "0.5";
  ...
  mpv = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, json ? null, lib, org }:
      elpaBuild {
        pname = "mpv";
        ename = "mpv";
        version = "0.2.0";
  ...
  nix-mode = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, magit-section, transient }:
      elpaBuild {
        pname = "nix-mode";
        ename = "nix-mode";
        version = "1.5.0";
  ...
  org-drill = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, org, persist, seq }:
      elpaBuild {
        pname = "org-drill";
        ename = "org-drill";
        version = "2.7.0";
  ...
  orgit = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, magit, org }:
    elpaBuild {
      pname = "orgit";
      ename = "orgit";
      version = "1.9.0";
  ...
  pdf-tools = callPackage
    ({ elpaBuild, emacs, fetchurl, let-alist, lib, tablist }:
      elpaBuild {
        pname = "pdf-tools";
        ename = "pdf-tools";
        version = "1.1.0";
  ...
  racket-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "racket-mode";
      ename = "racket-mode";
      ...
      src = fetchurl {
        url =
          "https://elpa.nongnu.org/nongnu/racket-mode-1.0.20230508.134227.tar";
  ...
  sass-mode = callPackage
    ({ cl-lib ? null, elpaBuild, fetchurl, haml-mode, lib }:
      elpaBuild {
        pname = "sass-mode";
        ename = "sass-mode";
        version = "3.0.16";
  ...
  telephone-line = callPackage
    ({ cl-generic, cl-lib ? null, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
  ...
  webpaste = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, request }:
      elpaBuild {
        pname = "webpaste";
        ename = "webpaste";
        version = "3.2.2";
  ...
  workroom = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib, project }:
    elpaBuild {
      pname = "workroom";
      ename = "workroom";
      version = "2.3";
  ...
  xah-fly-keys = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "xah-fly-keys";
      ename = "xah-fly-keys";
      ...
      src = fetchurl {
        url =
          "https://elpa.nongnu.org/nongnu/xah-fly-keys-23.11.20230609124049.tar";
