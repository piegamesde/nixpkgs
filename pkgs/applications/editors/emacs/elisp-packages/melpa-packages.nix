    ...
    let
      ...
      overrides =
        ...
        // {
          ...
          pdf-tools = super.pdf-tools.overrideAttrs (
            old: {
          ...
          pikchr-mode = super.pikchr-mode.overrideAttrs (
            attrs: {
              postPatch =
                attrs.postPatch or ""
                + ''
          ...
          typst-mode = super.typst-mode.overrideAttrs (
            attrs: {
              postPatch =
                attrs.postPatch or ""
                + ''
                  substituteInPlace typst-mode.el \
                    --replace 'typst-executable-location  "typst"' 'typst-executable-location "${
          ...
          wordnut = super.wordnut.overrideAttrs (
            attrs: {
              postPatch =
                attrs.postPatch or ""
                + ''
