{ callPackage }: {
  ace-window = callPackage ({ avy, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ace-window-0.10.0.0.20220911.35841.tar";
  ...
  ada-mode = callPackage
    ({ elpaBuild, emacs, fetchurl, gnat-compiler, lib, uniquify-files, wisi }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/ada-mode-8.0.5.0.20230208.70712.tar";
  ...
  ada-ref-man = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ada-ref-man-2020.1.0.20201129.190419.tar";
  ...
  adaptive-wrap = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/adaptive-wrap-0.8.0.20210602.91446.tar";
  ...
  adjust-parens = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/adjust-parens-3.1.0.20221221.73810.tar";
  ...
  advice-patch = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/advice-patch-0.1.0.20201220.233221.tar";
  ...
  aggressive-completion = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/aggressive-completion-1.7.0.20220417.71805.tar";
  ...
  aggressive-indent = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/aggressive-indent-1.10.0.0.20230112.100030.tar";
  ...
  ahungry-theme = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ahungry-theme-1.10.0.0.20211231.115425.tar";
  ...
  aircon-theme = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/aircon-theme-0.0.6.0.20220827.93355.tar";
  ...
  arbitools = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/arbitools-0.977.0.20221212.221354.tar";
  ...
  ascii-art-to-unicode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ascii-art-to-unicode-1.13.0.20221221.74335.tar";
  ...
  auto-correct = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/auto-correct-1.1.4.0.20221221.74656.tar";
  ...
  auto-header = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/auto-header-0.1.2.0.20230407.82136.tar";
  ...
  auto-overlays = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/auto-overlays-0.10.10.0.20201215.220815.tar";
  ...
  bind-key = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "bind-key";
      ename = "bind-key";
  ...
  bluetooth = callPackage ({ dash, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/bluetooth-0.3.1.0.20230119.122638.tar";
  ...
  boxy-headings = callPackage ({ boxy, elpaBuild, emacs, fetchurl, lib, org }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/boxy-headings-2.1.4.0.20221114.84552.tar";
  ...
  brief = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib, nadvice }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/brief-5.88.22.2.0.20230201.162442.tar";
  ...
  buffer-expose = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/buffer-expose-0.4.3.0.20190429.135558.tar";
  ...
  bug-hunter = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib, seq }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/bug-hunter-1.3.1.0.20201128.92354.tar";
  ...
  capf-autosuggest = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/capf-autosuggest-0.3.0.20211123.104430.tar";
  ...
  clipboard-collector = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/clipboard-collector-0.3.0.20190215.154741.tar";
  ...
  comint-mime = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/comint-mime-0.3.0.20230528.142235.tar";
  ...
  compact-docstrings = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/compact-docstrings-0.2.0.20220305.183958.tar";
  ...
  company-ebdb = callPackage ({ company, ebdb, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/company-ebdb-1.1.0.20221221.74915.tar";
  ...
  company-math = callPackage
    ({ company, elpaBuild, fetchurl, lib, math-symbol-lists }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/company-math-1.5.1.0.20221227.132907.tar";
  ...
  company-statistics = callPackage
    ({ company, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/company-statistics-0.2.3.0.20170210.193350.tar";
  ...
  consult-recoll = callPackage ({ consult, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/consult-recoll-0.8.0.20221014.200255.tar";
  ...
  context-coloring = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/context-coloring-8.1.0.0.20201127.182211.tar";
  ...
  csharp-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/csharp-mode-2.0.0.0.20221205.181941.tar";
  ...
  cycle-quotes = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/cycle-quotes-0.1.0.20221221.75021.tar";
  ...
  dbus-codegen = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/dbus-codegen-0.1.0.20220306.62546.tar";
  ...
  denote-menu = callPackage ({ denote, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/denote-menu-1.1.1.0.20230516.161156.tar";
  ...
  detached = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/detached-0.10.1.0.20221129.143049.tar";
  ...
  dired-git-info = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/dired-git-info-0.3.1.0.20191229.192948.tar";
  ...
  disk-usage = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/disk-usage-1.3.3.0.20220920.80620.tar";
  ...
  easy-escape = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/easy-escape-0.2.1.0.20210917.85414.tar";
  ...
  ebdb-gnorb = callPackage ({ ebdb, elpaBuild, fetchurl, gnorb, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ebdb-gnorb-1.0.2.0.20221221.75324.tar";
  ...
  ebdb-i18n-chn = callPackage ({ ebdb, elpaBuild, fetchurl, lib, pyim }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ebdb-i18n-chn-1.3.2.0.20221221.75334.tar";
  ...
  ef-themes = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ef-themes-1.1.1.0.20230608.174002.tar";
  ...
  el-search = callPackage
    ({ cl-print ? null, elpaBuild, emacs, fetchurl, lib, stream }:
      elpaBuild {
        pname = "el-search";
        ename = "el-search";
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/el-search-1.12.6.1.0.20221221.75346.tar";
  ...
  electric-spacing = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/electric-spacing-5.0.0.20201201.154407.tar";
  ...
  elisp-benchmarks = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/elisp-benchmarks-1.14.0.20221221.75401.tar";
  ...
  emacs-gc-stats = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/emacs-gc-stats-1.0.0.20230414.170313.tar";
  ...
  embark-consult = callPackage
    ({ consult, elpaBuild, emacs, embark, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/embark-consult-0.7.0.20230604.235020.tar";
  ...
  engrave-faces = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/engrave-faces-0.3.1.0.20230115.70118.tar";
  ...
  epoch-view = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/epoch-view-0.0.1.0.20221221.75416.tar";
  ...
  ergoemacs-mode = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, nadvice }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/ergoemacs-mode-5.16.10.12.0.20230207.95118.tar";
  ...
  excorporate = callPackage ({ cl-lib ? null, elpaBuild, emacs, fetchurl, fsm
    , lib, nadvice, soap-client, url-http-ntlm, url-http-oauth }:
    elpaBuild {
      pname = "excorporate";
      ename = "excorporate";
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/excorporate-1.1.1.0.20230529.173200.tar";
        sha256 = "1485cy2a8vzws2k796cj8a6dydjf8dagyid1ns04krzafvkfdnh4";
      };
      packageRequires =
        [ cl-lib emacs fsm nadvice soap-client url-http-ntlm url-http-oauth ];
      meta = {
  ...
  expand-region = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/expand-region-0.11.0.0.20200225.132539.tar";
  ...
  external-completion = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/external-completion-0.1.0.20230101.53112.tar";
  ...
  f90-interface-browser = callPackage
    ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/f90-interface-browser-1.1.0.20221221.75553.tar";
  ...
  face-shift = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/face-shift-0.2.1.0.20230426.73945.tar";
  ...
  filladapt = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/filladapt-2.12.2.0.20221221.75607.tar";
  ...
  firefox-javascript-repl = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/firefox-javascript-repl-0.9.5.0.20230605.161924.tar";
  ...
  flymake-proselint = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/flymake-proselint-0.3.0.0.20230325.160756.tar";
  ...
  frog-menu = callPackage ({ avy, elpaBuild, emacs, fetchurl, lib, posframe }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/frog-menu-0.2.11.0.20201115.95734.tar";
  ...
  gnat-compiler = callPackage ({ elpaBuild, emacs, fetchurl, lib, wisi }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/gnat-compiler-1.0.2.0.20230124.51334.tar";
  ...
  gnome-c-style = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/gnome-c-style-0.1.0.20160130.1526.tar";
  ...
  gnu-elpa-keyring-update = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/gnu-elpa-keyring-update-2022.12.0.20221228.123117.tar";
  ...
  gpr-mode = callPackage
    ({ elpaBuild, emacs, fetchurl, gnat-compiler, lib, wisi }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/gpr-mode-1.0.3.0.20230119.135149.tar";
  ...
  gpr-query = callPackage
    ({ elpaBuild, emacs, fetchurl, gnat-compiler, lib, wisi }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/gpr-query-1.0.3.0.20230128.112055.tar";
  ...
  guess-language = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, nadvice }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/guess-language-0.0.1.0.20190417.81229.tar";
  ...
  hiddenquote = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/hiddenquote-1.2.0.20221206.105559.tar";
  ...
  highlight-escape-sequences = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/highlight-escape-sequences-0.4.0.20201214.173014.tar";
  ...
  hook-helpers = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/hook-helpers-1.1.1.0.20201201.93957.tar";
  ...
  html5-schema = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/html5-schema-0.1.0.20221221.80245.tar";
  ...
  ivy-explorer = callPackage ({ elpaBuild, emacs, fetchurl, ivy, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ivy-explorer-0.3.2.0.20190909.192125.tar";
  ...
  ivy-hydra = callPackage ({ elpaBuild, emacs, fetchurl, hydra, ivy, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ivy-hydra-0.14.0.0.20230410.182324.tar";
  ...
  ivy-posframe = callPackage
    ({ elpaBuild, emacs, fetchurl, ivy, lib, posframe }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/ivy-posframe-0.6.3.0.20211217.23411.tar";
  ...
  jarchive = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/jarchive-0.10.0.0.20230118.130252.tar";
  ...
  js2-mode = callPackage ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/js2-mode-20230408.0.20230509.224433.tar";
  ...
  kind-icon = callPackage ({ elpaBuild, emacs, fetchurl, lib, svg-lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/kind-icon-0.2.0.0.20230506.135746.tar";
  ...
  latex-table-wizard = callPackage
    ({ auctex, elpaBuild, emacs, fetchurl, lib, transient }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/latex-table-wizard-1.5.2.0.20230516.145709.tar";
  ...
  load-relative = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/load-relative-1.3.2.0.20230214.53224.tar";
  ...
  math-symbol-lists = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/math-symbol-lists-1.3.0.20220828.204754.tar";
  ...
  memory-usage = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/memory-usage-0.2.0.20201201.223908.tar";
  ...
  minibuffer-header = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/minibuffer-header-0.5.0.20220921.71345.tar";
  ...
  minibuffer-line = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/minibuffer-line-0.1.0.20221221.80745.tar";
  ...
  modus-themes = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/modus-themes-4.2.0.0.20230610.24325.tar";
  ...
  multishell = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/multishell-1.1.10.0.20220605.120254.tar";
  ...
  names = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, nadvice }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/names-20151201.0.0.20220425.173515.tar";
  ...
  nano-agenda = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/nano-agenda-0.3.0.20230417.100538.tar";
  ...
  nano-modeline = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/nano-modeline-1.0.0.0.20230603.175642.tar";
  ...
  nano-theme = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/nano-theme-0.3.4.0.20230421.53238.tar";
  ...
  nftables-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/nftables-mode-1.1.0.20221221.80909.tar";
  ...
  nhexl-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "nhexl-mode";
      ename = "nhexl-mode";
  ...
  notes-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/notes-mode-1.30.0.20201201.121157.tar";
  ...
  notmuch-indicator = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/notmuch-indicator-0.2.2.0.20230101.153332.tar";
  ...
  on-screen = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/on-screen-1.3.3.0.20201127.191411.tar";
  ...
  org-contacts = callPackage ({ elpaBuild, emacs, fetchurl, lib, org }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/org-contacts-1.1.0.20230227.141730.tar";
  ...
  org-notify = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/org-notify-0.1.0.0.20221102.174044.tar";
  ...
  org-remark = callPackage ({ elpaBuild, emacs, fetchurl, lib, org }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/org-remark-1.1.0.0.20230520.73005.tar";
  ...
  org-transclusion = callPackage ({ elpaBuild, emacs, fetchurl, lib, org }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/org-transclusion-1.3.2.0.20230524.192243.tar";
  ...
  org-translate = callPackage ({ elpaBuild, emacs, fetchurl, lib, org }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/org-translate-0.1.4.0.20220312.90634.tar";
  ...
  other-frame-window = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/other-frame-window-1.0.6.0.20221221.81352.tar";
  ...
  package-fixes = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      pname = "package-fixes";
      ename = "package-fixes";
  ...
  parser-generator = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/parser-generator-0.1.6.0.20220512.173154.tar";
  ...
  path-iterator = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/path-iterator-1.0.0.20221221.81414.tar";
  ...
  phps-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/phps-mode-0.4.46.0.20230414.164307.tar";
  ...
  polymode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "polymode";
      ename = "polymode";
  ...
  prefixed-core = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      pname = "prefixed-core";
      ename = "prefixed-core";
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/prefixed-core-0.0.20221212.225529.tar";
  ...
  pyim-basedict = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/pyim-basedict-0.5.4.0.20220614.110824.tar";
  ...
  quarter-plane = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/quarter-plane-0.1.0.20221221.81727.tar";
  ...
  rainbow-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/rainbow-mode-1.0.6.0.20221221.81735.tar";
  ...
  rcirc-color = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/rcirc-color-0.4.5.0.20230414.195045.tar";
  ...
  realgud-ipdb = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-ipdb-1.0.0.0.20230320.62057.tar";
  ...
  realgud-jdb = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-jdb-1.0.0.0.20200722.72030.tar";
  ...
  realgud-lldb = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-lldb-1.0.2.0.20230319.171320.tar";
  ...
  realgud-node-debug = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-node-debug-1.0.0.0.20190525.123417.tar";
  ...
  realgud-node-inspect = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-node-inspect-1.0.0.0.20190526.154549.tar";
  ...
  realgud-trepan-ni = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-trepan-ni-1.0.1.0.20210513.183733.tar";
  ...
  realgud-trepan-xpy = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, load-relative, realgud }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/realgud-trepan-xpy-1.0.1.0.20230322.184556.tar";
  ...
  register-list = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/register-list-0.1.0.20221212.230034.tar";
  ...
  rich-minority = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/rich-minority-1.0.3.0.20190419.83620.tar";
  ...
  rt-liberation = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/rt-liberation-5.0.20220503.141657.tar";
  ...
  rudel = callPackage ({ cl-generic, cl-lib ? null, cl-print ? null, elpaBuild
    , emacs, fetchurl, lib }:
    elpaBuild {
      pname = "rudel";
      ename = "rudel";
  ...
  scroll-restore = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/scroll-restore-1.0.0.20221221.81959.tar";
  ...
  shell-command-plus = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/shell-command+-2.4.2.0.20230311.131100.tar";
  ...
  shell-quasiquote = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/shell-quasiquote-0.0.20221221.82030.tar";
  ...
  site-lisp = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/site-lisp-0.1.1.0.20230423.152517.tar";
  ...
  sketch-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/sketch-mode-1.0.4.0.20230420.122954.tar";
  ...
  slime-volleyball = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/slime-volleyball-1.2.0.0.20221221.82156.tar";
  ...
  smalltalk-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/smalltalk-mode-4.0.0.20221221.82225.tar";
  ...
  smart-yank = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/smart-yank-0.1.1.0.20221221.82231.tar";
  ...
  soap-client = callPackage ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/soap-client-3.2.3.0.20230512.51050.tar";
  ...
  spacious-padding = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/spacious-padding-0.1.0.0.20230606.175440.tar";
  ...
  sql-cassandra = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/sql-cassandra-0.2.2.0.20221221.82336.tar";
  ...
  ssh-deploy = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ssh-deploy-3.1.14.0.20230129.90300.tar";
  ...
  standard-themes = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/standard-themes-1.2.0.0.20230602.54907.tar";
  ...
  substitute = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/substitute-0.1.8.0.20230409.85458.tar";
  ...
  svg-tag-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib, svg-lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/svg-tag-mode-0.3.2.0.20230110.182450.tar";
  ...
  switchy-window = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/switchy-window-1.3.0.20230411.180529.tar";
  ...
  sxhkdrc-mode = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/sxhkdrc-mode-1.0.0.0.20230210.123052.tar";
  ...
  system-packages = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/system-packages-1.0.11.0.20220409.62318.tar";
  ...
  taxy-magit-section = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, magit-section, taxy }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/taxy-magit-section-0.12.2.0.20230223.182024.tar";
  ...
  temp-buffer-browse = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/temp-buffer-browse-1.5.0.20160804.124501.tar";
  ...
  test-simple = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/test-simple-1.3.0.0.20200722.214339.tar";
  ...
  timerfunctions = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/timerfunctions-1.4.2.0.20221221.82440.tar";
  ...
  tramp-nspawn = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/tramp-nspawn-1.0.1.0.20220923.120957.tar";
  ...
  transcribe = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/transcribe-1.5.2.0.20221221.82457.tar";
  ...
  transient = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/transient-0.4.1.0.20230602.212120.tar";
  ...
  transient-cycles = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/transient-cycles-1.0.0.20220410.130412.tar";
  ...
  tree-inspector = callPackage ({ elpaBuild, emacs, fetchurl, lib, treeview }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/tree-inspector-0.3.0.20230505.172252.tar";
  ...
  ulisp-repl = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/ulisp-repl-1.0.3.0.20230604.111559.tar";
  ...
  undo-tree = callPackage ({ elpaBuild, emacs, fetchurl, lib, queue }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/undo-tree-0.8.2.0.20220312.180415.tar";
  ...
  uni-confusables = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/uni-confusables-0.3.0.20221212.230830.tar";
  ...
  uniquify-files = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/uniquify-files-1.0.4.0.20221221.82507.tar";
  ...
  url-http-ntlm = callPackage
    ({ cl-lib ? null, elpaBuild, fetchurl, lib, ntlm ? null }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/url-http-ntlm-2.0.4.0.20221221.82537.tar";
  ...
  url-http-oauth = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/url-http-oauth-0.8.3.0.20230510.175959.tar";
  ...
  use-package = callPackage ({ bind-key, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/use-package-2.4.5.0.20230115.133305.tar";
  ...
  validate = callPackage
    ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib, seq }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/validate-1.0.4.0.20180215.204244.tar";
  ...
  vc-backup = callPackage ({ compat, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "vc-backup";
      ename = "vc-backup";
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/vc-backup-1.1.0.0.20220825.144758.tar";
  ...
  vc-hgcmd = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/vc-hgcmd-1.14.1.0.20230605.161947.tar";
  ...
  verilog-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/verilog-mode-2023.6.6.141322628.0.20230606.214619.tar";
  ...
  vertico-posframe = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, posframe, vertico }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/vertico-posframe-0.7.2.0.20230222.73835.tar";
  ...
  visual-filename-abbrev = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/visual-filename-abbrev-1.2.0.20221221.82606.tar";
  ...
  visual-fill = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/visual-fill-0.1.0.20201201.173845.tar";
  ...
  wcheck-mode = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/wcheck-mode-2021.0.20220101.81620.tar";
  ...
  web-server = callPackage ({ cl-lib ? null, elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      pname = "web-server";
      ename = "web-server";
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/web-server-0.1.2.0.20210811.22503.tar";
  ...
  which-key = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/which-key-3.6.0.0.20230606.182727.tar";
  ...
  wisitoken-grammar-mode = callPackage
    ({ elpaBuild, emacs, fetchurl, lib, mmm-mode, wisi }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/wisitoken-grammar-mode-1.3.0.0.20230125.102656.tar";
  ...
  xref-union = callPackage ({ elpaBuild, emacs, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/xref-union-0.1.1.0.20230325.142012.tar";
  ...
  yasnippet = callPackage ({ cl-lib ? null, elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/yasnippet-0.14.0.0.20210502.75302.tar";
  ...
  yasnippet-classic-snippets = callPackage
    ({ elpaBuild, fetchurl, lib, yasnippet }:
      elpaBuild {
        ...
        src = fetchurl {
          url =
            "https://elpa.gnu.org/devel/yasnippet-classic-snippets-1.0.2.0.20221221.83103.tar";
  ...
  zones = callPackage ({ elpaBuild, fetchurl, lib }:
    elpaBuild {
      ...
      src = fetchurl {
        url =
          "https://elpa.gnu.org/devel/zones-2019.7.13.0.20221212.231608.tar";
