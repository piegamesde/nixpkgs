...
let
  binaryPackage = stdenv.mkDerivation {
    ...
    postFixup = ''
      ...
      wrapProgram $out/plugin_host --prefix LD_PRELOAD : ${stdenv.cc.cc.lib}/lib${lib.optionalString stdenv.is64bit "64"}/libgcc_s.so.1:${
        lib.getLib openssl
      }/lib/libssl.so:${bzip2.out}/lib/libbz2.so
    '';
  };
in
