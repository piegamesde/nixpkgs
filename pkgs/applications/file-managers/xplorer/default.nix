{ lib, cmake, dbus, fetchFromGitHub, fetchYarnDeps, freetype, gtk3, libsoup
, mkYarnPackage, openssl, pkg-config, rustPlatform, webkitgtk }:
  ...
  cargoLock = {
    ...
    outputHashes = {
      "tauri-plugin-window-state-0.1.0" =
        "sha256-DkKiwBwc9jrxMaKWOyvl9nsBJW0jBe8qjtqIdKJmsnc=";
      "window-shadows-0.2.0" =
        "sha256-e1afzVjVUHtckMNQjcbtEQM0md+wPWj0YecbFvD0LKE=";
      "window-vibrancy-0.3.0" =
        "sha256-0psa9ZtdI0T6sC1RJ4GeI3w01FdO2Zjypuk9idI5pBY=";
    };
  };
