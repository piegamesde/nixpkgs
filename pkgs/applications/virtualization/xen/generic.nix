...
stdenv.mkDerivation (
  rec {
    ...
    meta = {
      ...
      description = "Xen hypervisor and related components" + optionalString (args ? meta && args.meta ? description) " (${args.meta.description})";
      longDescription =
      ...
      ] ++ lib.optionals (lib.versionOlder version "4.15") [ "This version of Xen has reached its end of life. See https://xenbits.xen.org/docs/unstable/support-matrix.html" ];
    } // (config.meta or { });
  }
  // removeAttrs config [
    "xenfiles"
