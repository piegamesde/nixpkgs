{ lib, stdenv, bash-completion, fetchurl, fetchpatch, gdbm, glib
, gsettings-desktop-schemas, gtk-vnc, gtk3, intltool, libcap, libgovirt
...
, ovirtSupport ? false, libvirt, libvirt-glib, libxml2, meson, ninja, pkg-config
, python3, shared-mime-info, spice-gtk, spice-protocol, spiceSupport ? true, vte
, wrapGAppsHook }:
